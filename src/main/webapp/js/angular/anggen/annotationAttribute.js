...
.run(function($rootScope,securityService,annotationAttributeService, securityService ,annotationService,enumFieldService,tabService,relationshipService,entityService,fieldService,restrictionFieldService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityService,userService){
...
annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;}
$scope.addNew= function()
{
annotationAttributeService.setSelectedEntity(null);
annotationAttributeService.setEntityList(null);
annotationAttributeService.selectedEntity.show=true;
annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#annotationAttributeTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.annotationAttributeDetailForm.$valid) return; 
annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;annotationAttributeService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;if (row.isSelected)
{
...
annotationAttributeService.selectedEntity.tabList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<annotationAttributeService.selectedEntity.tabList.length; i++)

{

if (annotationAttributeService.selectedEntity.tabList[i].tabId==tabService.selectedEntity.tabId)

annotationAttributeService.selectedEntity.tabList.splice(i,1);

}

annotationAttributeService.selectedEntity.tabList.push(tabService.selectedEntity);
...
tabService.selectedEntity.restrictionEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<tabService.selectedEntity.restrictionEntityList.length; i++)

{

if (tabService.selectedEntity.restrictionEntityList[i].restrictionEntityId==restrictionEntityService.selectedEntity.restrictionEntityId)

tabService.selectedEntity.restrictionEntityList.splice(i,1);
...
restrictionEntityService.setSelectedEntity(null);
tabService.initRestrictionEntityList().then(function(response) {
tabService.childrenList.restrictionEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
enumFieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.roleList.push(roleService.selectedEntity);
enumFieldService.insert().then(function successCallBack(response) { 
roleService.selectedEntity.enumFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<roleService.selectedEntity.enumFieldList.length; i++)

{

if (roleService.selectedEntity.enumFieldList[i].enumFieldId==enumFieldService.selectedEntity.enumFieldId)

roleService.selectedEntity.enumFieldList.splice(i,1);

}

roleService.selectedEntity.enumFieldList.push(enumFieldService.selectedEntity);
...
enumFieldService.setSelectedEntity(null);
roleService.initEnumFieldList().then(function(response) {
...
projectService.selectedEntity.show=false;
projectService.selectedEntity.fieldList.push(fieldService.selectedEntity);
projectService.insert().then(function successCallBack(response) { 
fieldService.selectedEntity.projectList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<fieldService.selectedEntity.projectList.length; i++)

{

if (fieldService.selectedEntity.projectList[i].projectId==projectService.selectedEntity.projectId)

fieldService.selectedEntity.projectList.splice(i,1);

}

fieldService.selectedEntity.projectList.push(projectService.selectedEntity);
...
projectService.setSelectedEntity(null);
fieldService.initProjectList().then(function(response) {
fieldService.childrenList.projectList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
userService.selectedEntity.show=false;
userService.selectedEntity.projectList.push(projectService.selectedEntity);
userService.insert().then(function successCallBack(response) { 
projectService.selectedEntity.userList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<projectService.selectedEntity.userList.length; i++)

{

if (projectService.selectedEntity.userList[i].userId==userService.selectedEntity.userId)

projectService.selectedEntity.userList.splice(i,1);

}

projectService.selectedEntity.userList.push(userService.selectedEntity);
...
userService.setSelectedEntity(null);
projectService.initUserList().then(function(response) {
projectService.childrenList.userList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.userList.push(userService.selectedEntity);
enumValueService.insert().then(function successCallBack(response) { 
userService.selectedEntity.enumValueList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<userService.selectedEntity.enumValueList.length; i++)

{

if (userService.selectedEntity.enumValueList[i].enumValueId==enumValueService.selectedEntity.enumValueId)

userService.selectedEntity.enumValueList.splice(i,1);

}

userService.selectedEntity.enumValueList.push(enumValueService.selectedEntity);
...
enumValueService.setSelectedEntity(null);
userService.initEnumValueList().then(function(response) {
userService.childrenList.enumValueList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("entityController",function($scope,$http,entityService, securityService ,fieldService,tabService,enumFieldService,annotationService,relationshipService,annotationAttributeService,enumEntityService,projectService,entityGroupService,restrictionEntityGroupService,roleService,restrictionFieldService,restrictionEntityService,userService,enumValueService)
{
//enumValue
...
.controller("enumEntityController",function($scope,$http,enumEntityService, securityService ,projectService,enumValueService)
{
//entity
...
enumEntityService.selectedEntity.show=false;
enumEntityService.selectedEntity.entityList.push(entityService.selectedEntity);
enumEntityService.insert().then(function successCallBack(response) { 
entityService.selectedEntity.enumEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityService.selectedEntity.enumEntityList.length; i++)

{

if (entityService.selectedEntity.enumEntityList[i].enumEntityId==enumEntityService.selectedEntity.enumEntityId)

entityService.selectedEntity.enumEntityList.splice(i,1);

}

entityService.selectedEntity.enumEntityList.push(enumEntityService.selectedEntity);
...
enumEntityService.setSelectedEntity(null);
entityService.initEnumEntityList().then(function(response) {
entityService.childrenList.enumEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
relationshipService.selectedEntity.show=false;
relationshipService.selectedEntity.enumEntityList.push(enumEntityService.selectedEntity);
relationshipService.insert().then(function successCallBack(response) { 
enumEntityService.selectedEntity.relationshipList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumEntityService.selectedEntity.relationshipList.length; i++)

{

if (enumEntityService.selectedEntity.relationshipList[i].relationshipId==relationshipService.selectedEntity.relationshipId)

enumEntityService.selectedEntity.relationshipList.splice(i,1);

}

enumEntityService.selectedEntity.relationshipList.push(relationshipService.selectedEntity);
...
relationshipService.setSelectedEntity(null);
enumEntityService.initRelationshipList().then(function(response) {
enumEntityService.childrenList.relationshipList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
relationshipService.selectedEntity.restrictionFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<relationshipService.selectedEntity.restrictionFieldList.length; i++)

{

if (relationshipService.selectedEntity.restrictionFieldList[i].restrictionFieldId==restrictionFieldService.selectedEntity.restrictionFieldId)

relationshipService.selectedEntity.restrictionFieldList.splice(i,1);

}

relationshipService.selectedEntity.restrictionFieldList.push(restrictionFieldService.selectedEntity);
...
restrictionFieldService.setSelectedEntity(null);
relationshipService.initRestrictionFieldList().then(function(response) {
relationshipService.childrenList.restrictionFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

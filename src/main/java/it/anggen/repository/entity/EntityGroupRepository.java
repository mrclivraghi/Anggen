    ...
    extends JpaRepository<it.anggen.model.entity.EntityGroup, java.lang.Long>
{
    ...
    @Query("select e from EntityGroup e where  (:entityGroupId is null or cast(:entityGroupId as string)=cast(e.entityGroupId as string)) and (:name is null or :name='' or cast(:name as string)=e.name) and (:securityType is null or cast(:securityType as string)=cast(e.securityType as string)) and (:restrictionEntityGroup in elements(e.restrictionEntityGroupList)  or :restrictionEntityGroup is null) and (:entity in elements(e.entityList)  or :entity is null) and (:project=e.project or :project is null) ")
    public List<it.anggen.model.entity.EntityGroup> findByEntityGroupIdAndNameAndSecurityTypeAndRestrictionEntityGroupAndEntityAndProject(

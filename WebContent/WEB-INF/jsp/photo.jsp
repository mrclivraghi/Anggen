...
<script type="text/javascript"
	src="../resources/general_theme/js/angular/photo.js"></script>
<script type="text/javascript"
...
<body ng-app="photoApp">
	<div ng-controller="photoController">
		<form id="photoSearchBean">
			<div class="panel panel-default default-panel">
				<div class="panel-heading">Search form photo</div>
				<div class="panel-body">
					<div class="pull-left right-input">
						<label id="photoId">photoId</label><input class="form-control "
							aria-describedby="sizing-addon3" type="text"
							ng-model="searchBean.photoId" ng-readonly="false" name="photoId"
							placeholder="photoId" id="photo-photoId" />
					</div>
					<div class="pull-right right-input">
						<label id="url">url</label><input class="form-control "
							aria-describedby="sizing-addon3" type="text"
							ng-model="searchBean.url" ng-readonly="false" name="url"
							placeholder="url" id="photo-url" />
					</div>
					<div class="pull-left right-input">
						<label id="social">social</label><input class="form-control "
							aria-describedby="sizing-addon3" type="text"
							ng-model="searchBean.social" ng-readonly="false" name="social"
							placeholder="social" id="photo-social" />
					</div>
					<div class="pull-right right-input">
						<label id="date">date</label><input class="form-control "
							aria-describedby="sizing-addon3" type="text"
							ui-date="{ dateFormat: &#39;dd/mm/yy&#39; }"
							ui-date-format="dd/mm/yy" ng-model="searchBean.date"
					...
					<div class="pull-left right-input">
						<label id="status">status</label><input class="form-control "
							...
							placeholder="status" id="photo-status" />
					</div>
					<div class="pull-right right-input">
						<label id="socialId">socialId</label><input class="form-control "
							aria-describedby="sizing-addon3" type="text"
							ng-model="searchBean.socialId" ng-readonly="false"
							name="socialId" placeholder="socialId" id="photo-socialId" />
					</div>
					<div class="pull-left right-input">
						<label id="relatedPost">relatedPost</label><input
							class="form-control " aria-describedby="sizing-addon3"
							type="text" ng-model="searchBean.relatedPost" ng-readonly="false"
			...
			<div class="panel panel-default default-panel">
				...
				<div class="panel-body">
					...
					<div class="pull-right right-input">
						...
						<button ng-click="showSeedQueryDetail()()" class="btn btn-default"
							ng-if="selectedEntity.seedQuery==null">Add new seedQuery</button>
						<label for="seedQuery">seedQuery</label>
						<p ng-click="showSeedQueryDetail()"
							ng-if="selectedEntity.seedQuery!=null">seedQuery:
							{{selectedEntity.seedQuery.seedQueryId}}</p>
					</div>
				</div>
				<div class="panel-body">
					<div class="pull-left">
			...
			<div class="panel panel-default default-panel">
				...
				<div class="panel-body">
					...
					<div ng-show="seedQueryDetailForm.status.$error.required">seedQuery:
						status required</div>
					<div class="pull-right right-input">
						<label id="mountain">mountain</label>
						...
						<p ng-click="showMountainDetail()"
							ng-if="selectedEntity.mountain!=null">mountain:
							{{selectedEntity.mountain.mountainId}}</p>
					</div>
				</div>
				<div class="panel-body">
					<div class="pull-left">

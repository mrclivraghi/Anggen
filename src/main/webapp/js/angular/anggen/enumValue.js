...
.run(function($rootScope,securityService,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,restrictionEntityGroupService,roleService,restrictionFieldService,fieldService,tabService,enumFieldService,annotationService,relationshipService,entityService,restrictionEntityService,annotationAttributeService,userService){
...
enumValueService.selectedEntity.restrictionFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.restrictionFieldList.length; i++)

{

if (enumValueService.selectedEntity.restrictionFieldList[i].restrictionFieldId==restrictionFieldService.selectedEntity.restrictionFieldId)

enumValueService.selectedEntity.restrictionFieldList.splice(i,1);

}

enumValueService.selectedEntity.restrictionFieldList.push(restrictionFieldService.selectedEntity);
...
restrictionFieldService.setSelectedEntity(null);
enumValueService.initRestrictionFieldList().then(function(response) {
enumValueService.childrenList.restrictionFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
roleService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<roleService.selectedEntity.annotationList.length; i++)

{

if (roleService.selectedEntity.annotationList[i].annotationId==annotationService.selectedEntity.annotationId)

roleService.selectedEntity.annotationList.splice(i,1);

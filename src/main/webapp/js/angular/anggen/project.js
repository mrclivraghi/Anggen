...
.run(function($rootScope,securityService,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService){
...
entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;}
$scope.addNew= function()
{
projectService.setSelectedEntity(null);
projectService.setEntityList(null);
projectService.selectedEntity.show=true;
entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#projectTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.projectDetailForm.$valid) return; 
entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;projectService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("tabController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
tabService.selectedEntity.show=false;
tabService.selectedEntity.project={};
tabService.selectedEntity.project.projectId=projectService.selectedEntity.projectId;
...
.controller("annotationController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.project={};
annotationService.selectedEntity.project.projectId=projectService.selectedEntity.projectId;
...
.controller("enumFieldController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
enumFieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.project={};
enumFieldService.selectedEntity.project.projectId=projectService.selectedEntity.projectId;
...
.controller("fieldController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
projectService.selectedEntity.field=response.data;
...
projectService.selectedEntity.field=fieldService.selectedEntity;
...
{
fieldService.selectedEntity.show=false;
projectService.selectedEntity.field=null;
fieldService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("enumValueController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.project={};
enumValueService.selectedEntity.project.projectId=projectService.selectedEntity.projectId;
...
.controller("annotationAttributeController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
annotationAttributeService.selectedEntity.show=false;
annotationAttributeService.selectedEntity.project={};
annotationAttributeService.selectedEntity.project.projectId=projectService.selectedEntity.projectId;
...
.controller("enumEntityController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
projectService.selectedEntity.enumEntity=response.data;
...
projectService.selectedEntity.enumEntity=enumEntityService.selectedEntity;
...
{
enumEntityService.selectedEntity.show=false;
projectService.selectedEntity.enumEntity=null;
enumEntityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("entityGroupController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
entityGroupService.selectedEntity.show=false;
entityGroupService.selectedEntity.project={};
entityGroupService.selectedEntity.project.projectId=projectService.selectedEntity.projectId;
...
.controller("roleController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
projectService.selectedEntity.role=response.data;
...
projectService.selectedEntity.role=roleService.selectedEntity;
...
{
roleService.selectedEntity.show=false;
projectService.selectedEntity.role=null;
roleService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("entityController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.project={};
entityService.selectedEntity.project.projectId=projectService.selectedEntity.projectId;
...
.controller("userController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
.controller("restrictionFieldController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
restrictionFieldService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.project={};
restrictionFieldService.selectedEntity.project.projectId=projectService.selectedEntity.projectId;
...
.controller("restrictionEntityGroupController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
restrictionEntityGroupService.selectedEntity.show=false;
restrictionEntityGroupService.selectedEntity.project={};
restrictionEntityGroupService.selectedEntity.project.projectId=projectService.selectedEntity.projectId;
...
.controller("restrictionEntityController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
restrictionEntityService.selectedEntity.show=false;
restrictionEntityService.selectedEntity.project={};
restrictionEntityService.selectedEntity.project.projectId=projectService.selectedEntity.projectId;
...
.controller("relationshipController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,enumValueService,annotationAttributeService,userService)
{
//project
...
relationshipService.selectedEntity.show=false;
relationshipService.selectedEntity.project={};
relationshipService.selectedEntity.project.projectId=projectService.selectedEntity.projectId;
relationshipService.insert().then(function successCallBack(response) { 
projectService.selectedEntity.relationshipList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<projectService.selectedEntity.relationshipList.length; i++)

{

if (projectService.selectedEntity.relationshipList[i].relationshipId==relationshipService.selectedEntity.relationshipId)

projectService.selectedEntity.relationshipList.splice(i,1);

}

projectService.selectedEntity.relationshipList.push(relationshipService.selectedEntity);
...
projectService.childrenList.relationshipList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

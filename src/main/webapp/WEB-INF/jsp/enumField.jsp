...
<script type="text/javascript" src="../js/angular/enumField.js"></script>
...
<body ng-app="enumFieldApp">
	<div ng-controller="enumFieldController">
		<form id="enumFieldSearchBean">
			<div class="panel panel-default default-panel">
				<div class="panel-heading">Search form enumField</div>
					...
					<div class="pull-left right-input">
						<div class="input-group">
							<span class="input-group-addon">enumFieldId</span><input
								...
								ng-model="searchBean.enumFieldId" ng-readonly="false"
					...
					<div class="pull-left right-input">
						<div class="input-group">
							<span class="input-group-addon">name</span><input
								class="form-control " aria-describedby="sizing-addon3"
								type="text" id="enumField-name" ng-model="searchBean.name"
					...
					<div class="pull-left right-input" style="height: 59px;">
						<div class="input-group">
							<span class="input-group-addon">enumValue</span><select
								class="form-control " aria-describedby="sizing-addon3"
								ng-model="searchBean.enumValue.enumValueId" id="enumValue"
								ng-options="enumValue.enumValueId as enumValue.enumValueId for enumValue in childrenList.enumValueList"
					...
					<div class="pull-left right-input" style="height: 59px;">
						<div class="input-group">
							<span class="input-group-addon">tab</span><select
								...
								ng-options="tab.tabId as tab.tabId for tab in childrenList.tabList"
								enctype="UTF-8"></select>
						</div>
					</div>
				</div>
				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="enumField-Detail">
							...
							<div class="pull-left right-input"
								ng-class="{&#39;has-error&#39;: !enumFieldDetailForm.entity.$valid, &#39;has-success&#39;: enumFieldDetailForm.entity.$valid}"
								style="height: 59px">
								<div class="input-group">
									<span class="input-group-addon">entity</span><select
										class="form-control " aria-describedby="sizing-addon3"
	...
	<div ng-controller="enumValueController">
		...
		<form id="enumValueDetailForm" name="enumValueDetailForm"
			...
			<div class="panel panel-default default-panel">
				...
				<script type="text/javascript">
					$('#enumValueTabs a:first').tab('show');
				</script>
				<div class="panel-body">
					<div class="pull-left">
				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="tab-Detail">
							...
							<div id="tab-relationship" class="modal fade" role="dialog">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal">&times;</button>
							...
							<div class="pull-left" style="width: 100%">
								<div class="panel panel-default default-panel">
									<div class="panel-heading">
										...
										<button type="button" class="btn btn-default pull-right"
											style="margin-top: -7px" data-toggle="modal"
											data-target="#tab-relationship">Link existing</button>
										<button ng-click="downloadRelationshipList()"
											class="btn btn-default pull-right" style="margin-top: -7px">
											<span class="glyphicon glyphicon-download-alt"
												aria-hidden="true"></span>
									...
									<div class="panel-body"
										ng-class="{&#39;has-error&#39;: !tabDetailForm.relationship.$valid, &#39;has-success&#39;: tabDetailForm.relationship.$valid}">
										<label id="relationship">relationship</label>
										<div id="relationship"
											ng-if="selectedEntity.relationshipList.length&gt;0">
											<div style="top: 100px" ui-grid="relationshipListGridOptions"
				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade"
							...
							<div class="pull-left right-input"
								ng-class="{&#39;has-error&#39;: !restrictionEntityDetailForm.role.$valid, &#39;has-success&#39;: restrictionEntityDetailForm.role.$valid}"
								style="height: 59px">
								<div class="input-group">
	...
	<div ng-controller="roleController">
		...
		<form id="roleDetailForm" name="roleDetailForm"
			...
			<div class="panel panel-default default-panel">
										...
										<div class="modal-body">
											...
											<div class="input-group">
												<span class="input-group-addon">user</span><select
													...
													ng-options="user as user.userId for user in childrenList.userList track by user.userId"
													enctype="UTF-8"></select><span class="input-group-btn"><button
				...
				<script type="text/javascript">$('#roleTabs a:first').tab('show');</script>
				<div class="panel-body">
					<div class="pull-left">
				...
				<div class="panel-body">
					<div class="pull-left">
						<form id="userActionButton" ng-if="selectedEntity.show">
							...
							<button ng-click="remove()" class="btn btn-default "
								ng-if="selectedEntity.userId&gt;0">Remove</button>
						</form>
					</div>
				</div>
			</div>
			...
			<div class="panel panel-default default-panel">
				...
				<div class="panel-body">
					<ul class="nav nav-tabs" role="tablist"
						...
						<script type="text/javascript">$('a[href="#restrictionEntityGroup-Detail"]').on('shown.bs.tab', function (e) {
var target = $(e.target).attr("href"); // activated tab
//console.log(target);
if (angular.element($('#restrictionEntityGroupTabs')).scope()!=null && angular.element($('#restrictionEntityGroupTabs')).scope()!=undefined) 
angular.element($('#restrictionEntityGroupTabs')).scope().refreshTableDetail();
});
</script>
					</ul>
					<div class="tab-content">
				...
				<script type="text/javascript">$('#restrictionEntityGroupTabs a:first').tab('show');</script>
				<div class="panel-body">
					<div class="pull-left">
...
angular.element($('#annotationAttributeTabs')).scope().refreshTableDetail();
	...
	<script type="text/javascript">loadMenu();  activeMenu("enumField");</script>
</body>
</html>
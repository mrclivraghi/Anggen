...
{
if (!$scope.enumFieldDetailForm.$valid) return; 
entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;enumFieldService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("tabController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
.controller("restrictionFieldController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
restrictionFieldService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.enumField={};
restrictionFieldService.selectedEntity.enumField.enumFieldId=enumFieldService.selectedEntity.enumFieldId;
...
.controller("annotationController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.enumField={};
annotationService.selectedEntity.enumField.enumFieldId=enumFieldService.selectedEntity.enumFieldId;
...
.controller("projectController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
projectService.selectedEntity.show=false;
projectService.selectedEntity.enumFieldList.push(enumFieldService.selectedEntity);
...
.controller("enumValueController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
annotationAttributeService.selectedEntity.show=false;
annotationAttributeService.selectedEntity.enumField={};
annotationAttributeService.selectedEntity.enumField.enumFieldId=enumFieldService.selectedEntity.enumFieldId;
...
.controller("roleController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
enumFieldService.selectedEntity.role=response.data;
enumFieldService.initRoleList().then(function(response) {
enumFieldService.childrenList.roleList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
enumFieldService.selectedEntity.role=roleService.selectedEntity;
...
{
roleService.selectedEntity.show=false;
enumFieldService.selectedEntity.role=null;
roleService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("entityController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
restrictionEntityGroupService.selectedEntity.show=false;
restrictionEntityGroupService.selectedEntity.enumField={};
restrictionEntityGroupService.selectedEntity.enumField.enumFieldId=enumFieldService.selectedEntity.enumFieldId;
...
.controller("entityGroupController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
.controller("userController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
enumFieldService.selectedEntity.userList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumFieldService.selectedEntity.userList.length; i++)

{

if (enumFieldService.selectedEntity.userList[i].userId==userService.selectedEntity.userId)

enumFieldService.selectedEntity.userList.splice(i,1);
...
userService.setSelectedEntity(null);
enumFieldService.initUserList().then(function(response) {
enumFieldService.childrenList.userList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("fieldController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
.controller("restrictionEntityController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
restrictionEntityService.selectedEntity.show=false;
restrictionEntityService.selectedEntity.enumField={};
restrictionEntityService.selectedEntity.enumField.enumFieldId=enumFieldService.selectedEntity.enumFieldId;
...
.controller("relationshipController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
.controller("enumEntityController",function($scope,$http,enumFieldService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,annotationAttributeService,userService)
{
//enumField
...
enumFieldService.selectedEntity.enumEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumFieldService.selectedEntity.enumEntityList.length; i++)

{

if (enumFieldService.selectedEntity.enumEntityList[i].enumEntityId==enumEntityService.selectedEntity.enumEntityId)

enumFieldService.selectedEntity.enumEntityList.splice(i,1);

}

enumFieldService.selectedEntity.enumEntityList.push(enumEntityService.selectedEntity);

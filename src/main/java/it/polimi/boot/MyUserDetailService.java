    ...
    implements UserDetailsService
{
    ...
    private org.springframework.security.core.userdetails.User buildUserForAuthentication(it.polimi.model.security.User user, List<GrantedAuthority> authorities) {

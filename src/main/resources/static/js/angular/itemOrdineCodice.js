...
itemOrdineService.selectedEntity.show=false;ordineService.selectedEntity.show=false;colloService.selectedEntity.show=false;}
$scope.addNew= function()
{
itemOrdineCodiceService.setSelectedEntity(null);
itemOrdineCodiceService.setEntityList(null);
itemOrdineCodiceService.selectedEntity.show=true;
itemOrdineService.selectedEntity.show=false;ordineService.selectedEntity.show=false;colloService.selectedEntity.show=false;$('#itemOrdineCodiceTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.itemOrdineCodiceDetailForm.$valid) return; 
itemOrdineService.selectedEntity.show=false;ordineService.selectedEntity.show=false;colloService.selectedEntity.show=false;itemOrdineCodiceService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
$scope.init();
$scope.itemOrdineCodiceGridOptions = {
...
{ name: 'vProductId'},
{ name: 'weightFinale'},
{ name: 'itemOrdine.itemOrdineId', displayName: 'itemOrdine'} 
]
,data: itemOrdineCodiceService.entityList
 };
...
itemOrdineCodiceService.setSelectedEntity(response);
if (toDo != null)
toDo();
},function errorCallback(response) {      
alert("error");
...
itemOrdineCodiceService.selectedEntity.itemOrdine=response.data;
itemOrdineCodiceService.initItemOrdineList().then(function(response) {
itemOrdineCodiceService.childrenList.itemOrdineList=response.data;
});
},function errorCallback(response) { 
alert("error");

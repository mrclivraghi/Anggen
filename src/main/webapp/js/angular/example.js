...
.service("exampleService", function($http)
	...
	this.initPlaceList= function()
	{
		...
		.controller("exampleController",function($scope,$http,exampleService,placeService,securityService)
				{
//			null
			...
			$scope.init=function()
			{
				securityService.init().then(function successCallback(response) {
					...
					console.log(securityService.restrictionList);
					if (securityService.restrictionList.place.canSearch)

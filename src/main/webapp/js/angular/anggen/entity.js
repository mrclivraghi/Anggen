...
.run(function($rootScope,securityService,entityService, securityService ,fieldService,tabService,restrictionFieldService,annotationService,entityGroupService,projectService,restrictionEntityGroupService,restrictionEntityService,roleService,enumFieldService,enumEntityService,relationshipService){
...
.controller("entityController",function($scope,$http,entityService, securityService ,fieldService,tabService,restrictionFieldService,annotationService,entityGroupService,projectService,restrictionEntityGroupService,restrictionEntityService,roleService,enumFieldService,enumEntityService,relationshipService)
{
//null
...
fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;}
$scope.addNew= function()
{
entityService.setSelectedEntity(null);
entityService.setEntityList(null);
entityService.selectedEntity.show=true;
fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;$('#entityTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.entityDetailForm.$valid) return; 
fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("annotationController",function($scope,$http,entityService, securityService ,fieldService,tabService,restrictionFieldService,annotationService,entityGroupService,projectService,restrictionEntityGroupService,restrictionEntityService,roleService,enumFieldService,enumEntityService,relationshipService)
{
//entity
...
.controller("tabController",function($scope,$http,entityService, securityService ,fieldService,tabService,restrictionFieldService,annotationService,entityGroupService,projectService,restrictionEntityGroupService,restrictionEntityService,roleService,enumFieldService,enumEntityService,relationshipService)
{
//entity
...
tabService.selectedEntity.show=false;
tabService.selectedEntity.entity={};
tabService.selectedEntity.entity.entityId=entityService.selectedEntity.entityId;
...
.controller("fieldController",function($scope,$http,entityService, securityService ,fieldService,tabService,restrictionFieldService,annotationService,entityGroupService,projectService,restrictionEntityGroupService,restrictionEntityService,roleService,enumFieldService,enumEntityService,relationshipService)
{
//entity
...
.controller("projectController",function($scope,$http,entityService, securityService ,fieldService,tabService,restrictionFieldService,annotationService,entityGroupService,projectService,restrictionEntityGroupService,restrictionEntityService,roleService,enumFieldService,enumEntityService,relationshipService)
{
//entity
...
projectService.selectedEntity.show=false;
projectService.selectedEntity.entity={};
projectService.selectedEntity.entity.entityId=entityService.selectedEntity.entityId;
...
.controller("roleController",function($scope,$http,entityService, securityService ,fieldService,tabService,restrictionFieldService,annotationService,entityGroupService,projectService,restrictionEntityGroupService,restrictionEntityService,roleService,enumFieldService,enumEntityService,relationshipService)
{
//entity
...
roleService.selectedEntity.show=false;
roleService.selectedEntity.entity={};
roleService.selectedEntity.entity.entityId=entityService.selectedEntity.entityId;
...
enumEntityService.selectedEntity.show=false;
enumEntityService.selectedEntity.entity={};
enumEntityService.selectedEntity.entity.entityId=entityService.selectedEntity.entityId;

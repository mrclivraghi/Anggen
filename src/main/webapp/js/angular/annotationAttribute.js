...
annotationService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;}
$scope.addNew= function()
{
annotationAttributeService.setSelectedEntity(null);
annotationAttributeService.setEntityList(null);
annotationAttributeService.selectedEntity.show=true;
annotationService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;$('#annotationAttributeTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.annotationAttributeDetailForm.$valid) return; 
annotationService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 

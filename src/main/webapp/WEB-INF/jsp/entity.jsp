...
<body ng-app="entityApp">
		...
		<form id="entitySearchBean">
			<div class="panel panel-default default-panel">
				...
				<div class="panel-body">
					...
					<div class="pull-left right-input" ng-show="true ">
						<div class="input-group">
							<span class="input-group-addon">enableRestrictionData</span><select
								class="form-control " aria-describedby="sizing-addon3"
								type="checkbox" id="entity-enableRestrictionData"
								ng-model="searchBean.enableRestrictionData" ng-readonly="false"
								name="enableRestrictionData" placeholder="enableRestrictionData"
					...
					<div class="pull-left right-input" style="height: 59px;"
						...
						<div class="input-group">
							<span class="input-group-addon">tab</span><select
								...
								ng-options="tab.tabId as  tab.name+&#39; &#39;+ tab.tabId for tab in childrenList.tabList"
								enctype="UTF-8"></select>
						</div>
					</div>
					<div class="pull-left right-input" style="height: 59px;"
					...
					<div class="pull-left right-input" style="height: 59px;"
						...
						<div class="input-group">
							<span class="input-group-addon">enumField</span><select
								...
								ng-options="enumField.enumFieldId as  enumField.enumFieldId+&#39; &#39;+ enumField.name for enumField in childrenList.enumFieldList"
								enctype="UTF-8"></select>
						</div>
					</div>
					<div class="pull-left right-input" style="height: 59px;"
				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="entity-Detail">
							...
							<div class="pull-left right-input"
								ng-class="{&#39;has-error&#39;: !entityDetailForm.enableRestrictionData.$valid, &#39;has-success&#39;: entityDetailForm.enableRestrictionData.$valid}"
								style="height: 59px" ng-show="true ">
								<div class="input-group">
									<span class="input-group-addon">enableRestrictionData</span><select
										class="form-control " aria-describedby="sizing-addon3"
										type="checkbox" id="entity-enableRestrictionData"
										ng-model="selectedEntity.enableRestrictionData"
										ng-readonly="restrictionList.entity.restrictionFieldMap.enableRestrictionData"
										name="enableRestrictionData"
										placeholder="enableRestrictionData"
										ng-options="value for value in trueFalseValues"></select>
								</div>
							</div>
							<div class="pull-left right-input"
										...
										<div class="modal-body">
											...
											<div class="input-group">
												<span class="input-group-addon">enumField</span><select
													...
													name="enumField"
													ng-options="enumField as  enumField.enumFieldId+&#39; &#39;+ enumField.name for enumField in childrenList.enumFieldList track by enumField.enumFieldId"
													enctype="UTF-8"></select><span class="input-group-btn"><button
										...
										<div class="modal-body">
											...
											<div class="input-group">
												<span class="input-group-addon">tab</span><select
													...
													ng-options="tab as  tab.name+&#39; &#39;+ tab.tabId for tab in childrenList.tabList track by tab.tabId"
													enctype="UTF-8"></select><span class="input-group-btn"><button
				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="tab-Detail">
							...
							<div id="tab-field" class="modal fade" role="dialog">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal">&times;</button>
							...
							<div class="pull-left" style="width: 100%"
								...
								<div class="panel panel-default default-panel">
									<div class="panel-heading">
										...
										<button type="button" class="btn btn-default pull-right"
											style="margin-top: -7px" data-toggle="modal"
											data-target="#tab-field">Link existing</button>
										<button ng-click="downloadFieldList()"
											class="btn btn-default pull-right" style="margin-top: -7px">
											<span class="glyphicon glyphicon-download-alt"
												aria-hidden="true"></span>
									...
									<div class="panel-body"
										ng-class="{&#39;has-error&#39;: !tabDetailForm.field.$valid, &#39;has-success&#39;: tabDetailForm.field.$valid}">
										<label id="field">field</label>
										<div id="field" ng-if="selectedEntity.fieldList.length&gt;0">
											<div style="top: 100px" ui-grid="fieldListGridOptions"
												ui-grid-pagination="" ui-grid-selection=""></div>
										...
										<div class="modal-body">
											...
											<div class="input-group">
												<span class="input-group-addon">annotationAttribute</span><select
													...
													ng-options="annotationAttribute as  annotationAttribute.property+&#39; &#39;+ annotationAttribute.annotationAttributeId for annotationAttribute in childrenList.annotationAttributeList track by annotationAttribute.annotationAttributeId"
													enctype="UTF-8"></select><span class="input-group-btn"><button
				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="enumField-Detail">
							...
							<div class="pull-left right-input"
								ng-class="{&#39;has-error&#39;: !enumFieldDetailForm.enumEntity.$valid, &#39;has-success&#39;: enumFieldDetailForm.enumEntity.$valid}"
								style="height: 59px" ng-show="true ">
								<div class="input-group">
									<span class="input-group-addon">enumEntity</span><select
										class="form-control " aria-describedby="sizing-addon3"
										ng-model="selectedEntity.enumEntity" id="enumEntity"
										name="enumEntity"
										ng-options="enumEntity as  enumEntity.enumEntityId+&#39; &#39;+ enumEntity.name for enumEntity in childrenList.enumEntityList track by enumEntity.enumEntityId"
										enctype="UTF-8"></select><span class="input-group-btn"><button
											ng-click="showEnumEntityDetail()" class="btn btn-default "
											id="enumEntity" ng-if="selectedEntity.enumEntity==null">Add
											new enumEntity</button>
										<button ng-click="showEnumEntityDetail()"
											class="btn btn-default " id="enumEntity"
											ng-if="selectedEntity.enumEntity!=null">Show detail</button></span>
								</div>
							</div>
						</div>
					</div>
	...
	<div ng-controller="enumEntityController">
		<form id="enumEntityList" ng-if="entityList.length&gt;0"
			enctype="UTF-8">
			<div class="panel panel-default default-panel">
				<div class="panel-heading">
					List enumEntity
				...
				<div class="panel-body">
					<div ui-grid="enumEntityGridOptions" ui-grid-pagination=""
						ui-grid-selection="" ui-grid-exporter=""></div>
				</div>
			</div>
		</form>
		<form id="enumEntityDetailForm" name="enumEntityDetailForm"
			ng-show="selectedEntity.show">
			<div class="panel panel-default default-panel">
				<div class="panel-heading">Detail enumEntity {{
					selectedEntity.enumEntityId }}</div>
				<div class="panel-body">
					<ul class="nav nav-tabs" role="tablist" id="enumEntityTabs">
						<li role="presentation"><a href="#enumEntity-Detail"
							aria-controls="Detail" role="tab" data-toggle="tab"
							ng-click="refreshTableDetail()">Detail</a></li>
						<script type="text/javascript">
							$('a[href="#enumEntity-Detail"]')
									.on(
											'shown.bs.tab',
											function(e) {
												var target = $(e.target).attr(
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="enumEntity-Detail">
							<div class="pull-left right-input"
								ng-class="{&#39;has-error&#39;: !enumEntityDetailForm.enumEntityId.$valid, &#39;has-success&#39;: enumEntityDetailForm.enumEntityId.$valid}"
								style="height: 59px" ng-show="true ">
								<div class="input-group">
									<span class="input-group-addon">enumEntityId</span><input
										class="form-control " aria-describedby="sizing-addon3"
										type="text" id="enumEntity-enumEntityId"
										ng-model="selectedEntity.enumEntityId" ng-readonly="true"
										name="enumEntityId" placeholder="enumEntityId" />
								</div>
							</div>
							<div class="pull-left right-input"
								ng-class="{&#39;has-error&#39;: !enumEntityDetailForm.name.$valid, &#39;has-success&#39;: enumEntityDetailForm.name.$valid}"
								style="height: 59px" ng-show="true ">
								<div class="input-group">
									<span class="input-group-addon">name</span><input
										class="form-control " aria-describedby="sizing-addon3"
										type="text" id="enumEntity-name"
										ng-model="selectedEntity.name"
										ng-readonly="restrictionList.enumEntity.restrictionFieldMap.name"
										name="name" placeholder="name" />
								</div>
							</div>
							<div id="enumEntity-enumValue" class="modal fade" role="dialog">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal">&times;</button>
							...
							<div class="pull-left" style="width: 100%"
								...
								<div class="panel panel-default default-panel">
									<div class="panel-heading">
										...
										<button type="button" class="btn btn-default pull-right"
											style="margin-top: -7px" data-toggle="modal"
											data-target="#enumEntity-enumValue">Link existing</button>
									...
									<div class="panel-body"
										ng-class="{&#39;has-error&#39;: !enumEntityDetailForm.enumValue.$valid, &#39;has-success&#39;: enumEntityDetailForm.enumValue.$valid}">
							...
							<div class="pull-left right-input"
								ng-class="{&#39;has-error&#39;: !enumEntityDetailForm.project.$valid, &#39;has-success&#39;: enumEntityDetailForm.project.$valid}"
								style="height: 59px" ng-show="true ">
								<div class="input-group">
									<span class="input-group-addon">project</span><select
										class="form-control " aria-describedby="sizing-addon3"
										ng-model="selectedEntity.project" id="project" name="project"
										ng-options="project as  project.projectId+&#39; &#39;+ project.name for project in childrenList.projectList track by project.projectId"
										enctype="UTF-8"></select><span class="input-group-btn"><button
				...
				<script type="text/javascript">
					$('#enumEntityTabs a:first').tab('show');
				</script>
				<div class="panel-body">
					<div class="pull-left">
						<form id="enumEntityActionButton" ng-if="selectedEntity.show">
							<button ng-click="insert()" class="btn btn-default "
								ng-if="selectedEntity.enumEntityId==undefined"
								ng-show="(restrictionList.enumEntity==undefined || restrictionList.enumEntity.canCreate==true)">Insert</button>
							<button ng-click="update()" class="btn btn-default "
								ng-if="selectedEntity.enumEntityId&gt;0"
								ng-show="(restrictionList.enumEntity==undefined || restrictionList.enumEntity.canUpdate==true)">Update</button>
							<button ng-click="del()" class="btn btn-default "
								ng-if="selectedEntity.enumEntityId&gt;0"
								ng-show="(restrictionList.enumEntity==undefined || restrictionList.enumEntity.canDelete==true)">Delete</button>
							<button ng-click="remove()" class="btn btn-default "
								ng-if="selectedEntity.enumEntityId&gt;0"
								ng-show="(restrictionList.enumEntity==undefined || restrictionList.enumEntity.canDelete==true)">Remove</button>
						</form>
					</div>
				</div>
			</div>
				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="project-Detail">
							...
							<div id="project-entityGroup" class="modal fade" role="dialog">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal">&times;</button>
											<h4 class="modal-title">Link existing entityGroup</h4>
										</div>
										<div class="modal-body">
											<p></p>
											<div class="input-group">
												<span class="input-group-addon">entityGroup</span><select
													...
													ng-options="entityGroup as  entityGroup.entityGroupId+&#39; &#39;+ entityGroup.name for entityGroup in childrenList.entityGroupList track by entityGroup.entityGroupId"
													enctype="UTF-8"></select><span class="input-group-btn"><button
														ng-click="saveLinkedEntityGroup()"
														class="btn btn-default " id="entityGroup">Save</button></span>
											</div>
										</div>
										<div class="modal-footer">
											<button ng-click="close()" class="btn btn-default "
							...
							<div class="pull-left" style="width: 100%"
								...
								<div class="panel panel-default default-panel">
									<div class="panel-heading">
										...
										<button ng-click="showEntityGroupDetail()"
											class="btn btn-default  pull-right" style="margin-top: -7px"
											ng-show="(restrictionList.entityGroup==undefined || restrictionList.entityGroup.canCreate==true)">Add
											new entityGroup</button>
										<button type="button" class="btn btn-default pull-right"
											style="margin-top: -7px" data-toggle="modal"
											data-target="#project-entityGroup">Link existing</button>
										<button ng-click="downloadEntityGroupList()"
											class="btn btn-default pull-right" style="margin-top: -7px">
											<span class="glyphicon glyphicon-download-alt"
												aria-hidden="true"></span>
										</button>
									...
									<div class="panel-body"
										ng-class="{&#39;has-error&#39;: !projectDetailForm.entityGroup.$valid, &#39;has-success&#39;: projectDetailForm.entityGroup.$valid}">
										<label id="entityGroup">entityGroup</label>
										<div id="entityGroup"
											ng-if="selectedEntity.entityGroupList.length&gt;0">
											<div style="top: 100px" ui-grid="entityGroupListGridOptions"
												ui-grid-pagination="" ui-grid-selection=""></div>
										</div>
									</div>
								</div>
				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="entityGroup-Detail">
							...
							<div id="entityGroup-restrictionEntityGroup" class="modal fade"
								role="dialog">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
							...
							<div class="pull-left" style="width: 100%"
								...
								<div class="panel panel-default default-panel">
									<div class="panel-heading">
										...
										<button type="button" class="btn btn-default pull-right"
											style="margin-top: -7px" data-toggle="modal"
											data-target="#entityGroup-restrictionEntityGroup">Link
											existing</button>
									...
									<div class="panel-body"
										ng-class="{&#39;has-error&#39;: !entityGroupDetailForm.restrictionEntityGroup.$valid, &#39;has-success&#39;: entityGroupDetailForm.restrictionEntityGroup.$valid}">
				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade"
							...
							<div class="pull-left right-input"
								ng-class="{&#39;has-error&#39;: !restrictionEntityGroupDetailForm.role.$valid, &#39;has-success&#39;: restrictionEntityGroupDetailForm.role.$valid}"
								style="height: 59px" ng-show="true ">
								<div class="input-group">
									<span class="input-group-addon">role</span><select
										class="form-control " aria-describedby="sizing-addon3"
										ng-model="selectedEntity.role" id="role" name="role"
										ng-options="role as  role.role+&#39; &#39;+ role.roleId for role in childrenList.roleList track by role.roleId"
										enctype="UTF-8"></select><span class="input-group-btn"><button
	...
	<div ng-controller="restrictionEntityController">
		...
		<form id="restrictionEntityDetailForm"
			...
			<div class="panel panel-default default-panel">
				...
				<script type="text/javascript">$('#restrictionEntityTabs a:first').tab('show');</script>
				<div class="panel-body">
					<div class="pull-left">
				...
				<div class="panel-body">
					<ul class="nav nav-tabs" role="tablist" id="restrictionFieldTabs">
						<li role="presentation"><a href="#restrictionField-Detail"
							aria-controls="Detail" role="tab" data-toggle="tab"
							ng-click="refreshTableDetail()">Detail</a></li>
						<script type="text/javascript">$('a[href="#restrictionField-Detail"]').on('shown.bs.tab', function (e) {
var target = $(e.target).attr("href"); // activated tab
//console.log(target);
if (angular.element($('#restrictionFieldTabs')).scope()!=null && angular.element($('#restrictionFieldTabs')).scope()!=undefined) 
angular.element($('#restrictionFieldTabs')).scope().refreshTableDetail();
});
</script>
					</ul>
					<div class="tab-content">
				...
				<script type="text/javascript">$('#restrictionFieldTabs a:first').tab('show');</script>
				<div class="panel-body">
					<div class="pull-left">
				...
				<div class="panel-body">
					<ul class="nav nav-tabs" role="tablist" id="userTabs">
						<li role="presentation"><a href="#user-Detail"
							aria-controls="Detail" role="tab" data-toggle="tab"
							ng-click="refreshTableDetail()">Detail</a></li>
						<script type="text/javascript">$('a[href="#user-Detail"]').on('shown.bs.tab', function (e) {
var target = $(e.target).attr("href"); // activated tab
//console.log(target);
...
angular.element($('#userTabs')).scope().refreshTableDetail();
				...
				<script type="text/javascript">$('#userTabs a:first').tab('show');</script>
				<div class="panel-body">
					<div class="pull-left">

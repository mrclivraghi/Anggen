...
.run(function($rootScope,securityService,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService){
...
.controller("enumFieldController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//null
...
tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;}
$scope.addNew= function()
{
enumFieldService.setSelectedEntity(null);
enumFieldService.setEntityList(null);
enumFieldService.selectedEntity.show=true;
tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;$('#enumFieldTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.enumFieldDetailForm.$valid) return; 
tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;enumFieldService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("enumValueController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//enumField
...
.controller("annotationAttributeController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//enumField
...
enumFieldService.selectedEntity.annotationAttributeList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumFieldService.selectedEntity.annotationAttributeList.length; i++)

{

if (enumFieldService.selectedEntity.annotationAttributeList[i].annotationAttributeId==annotationAttributeService.selectedEntity.annotationAttributeId)

enumFieldService.selectedEntity.annotationAttributeList.splice(i,1);

}

enumFieldService.selectedEntity.annotationAttributeList.push(annotationAttributeService.selectedEntity);
...
annotationAttributeService.setSelectedEntity(null);
enumFieldService.initAnnotationAttributeList().then(function(response) {
enumFieldService.childrenList.annotationAttributeList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("fieldController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//enumField
...
enumFieldService.selectedEntity.fieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumFieldService.selectedEntity.fieldList.length; i++)

{

if (enumFieldService.selectedEntity.fieldList[i].fieldId==fieldService.selectedEntity.fieldId)

enumFieldService.selectedEntity.fieldList.splice(i,1);
...
fieldService.setSelectedEntity(null);
enumFieldService.initFieldList().then(function(response) {
enumFieldService.childrenList.fieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("relationshipController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//enumField
...
.controller("entityController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//enumField
...
.controller("entityGroupController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//enumField
...
entityGroupService.selectedEntity.show=false;
entityGroupService.selectedEntity.enumField={};
entityGroupService.selectedEntity.enumField.enumFieldId=enumFieldService.selectedEntity.enumFieldId;
entityGroupService.insert().then(function successCallBack(response) { 
enumFieldService.selectedEntity.entityGroup=response.data;
...
enumFieldService.selectedEntity.entityGroup=entityGroupService.selectedEntity;
...
{
entityGroupService.selectedEntity.show=false;
enumFieldService.selectedEntity.entityGroup=null;
entityGroupService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("tabController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//enumField
...
if (!$scope.relationshipDetailForm.$valid) return; 
relationshipService.selectedEntity.show=false;
relationshipService.selectedEntity.enumField={};
relationshipService.selectedEntity.enumField.enumFieldId=enumFieldService.selectedEntity.enumFieldId;
relationshipService.insert().then(function successCallBack(response) { 
enumFieldService.selectedEntity.relationship=response.data;
enumFieldService.initRelationshipList().then(function(response) {
enumFieldService.childrenList.relationshipList=response.data;
});
},function errorCallback(response) { 
...
enumFieldService.selectedEntity.relationship=relationshipService.selectedEntity;
...
{
relationshipService.selectedEntity.show=false;
enumFieldService.selectedEntity.relationship=null;
relationshipService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("restrictionEntityController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//enumField
...
enumFieldService.selectedEntity.restrictionEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumFieldService.selectedEntity.restrictionEntityList.length; i++)

{

if (enumFieldService.selectedEntity.restrictionEntityList[i].restrictionEntityId==restrictionEntityService.selectedEntity.restrictionEntityId)

enumFieldService.selectedEntity.restrictionEntityList.splice(i,1);
...
restrictionEntityService.setSelectedEntity(null);
enumFieldService.initRestrictionEntityList().then(function(response) {
enumFieldService.childrenList.restrictionEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("projectController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//enumField
...
projectService.selectedEntity.show=false;
projectService.selectedEntity.enumField={};
projectService.selectedEntity.enumField.enumFieldId=enumFieldService.selectedEntity.enumFieldId;
projectService.insert().then(function successCallBack(response) { 
enumFieldService.selectedEntity.project=response.data;
enumFieldService.initProjectList().then(function(response) {
enumFieldService.childrenList.projectList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
enumFieldService.selectedEntity.project=projectService.selectedEntity;
...
{
projectService.selectedEntity.show=false;
enumFieldService.selectedEntity.project=null;
projectService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
if (!$scope.fieldDetailForm.$valid) return; 
fieldService.selectedEntity.show=false;
fieldService.selectedEntity.enumField={};
fieldService.selectedEntity.enumField.enumFieldId=enumFieldService.selectedEntity.enumFieldId;
fieldService.insert().then(function successCallBack(response) { 
enumFieldService.selectedEntity.field=response.data;
enumFieldService.initFieldList().then(function(response) {
enumFieldService.childrenList.fieldList=response.data;
});
},function errorCallback(response) { 
...
enumFieldService.selectedEntity.field=fieldService.selectedEntity;
...
{
fieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.field=null;
fieldService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("annotationController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//enumField
...
enumFieldService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumFieldService.selectedEntity.annotationList.length; i++)

{

if (enumFieldService.selectedEntity.annotationList[i].annotationId==annotationService.selectedEntity.annotationId)

enumFieldService.selectedEntity.annotationList.splice(i,1);
...
if (!$scope.tabDetailForm.$valid) return; 
tabService.selectedEntity.show=false;
tabService.selectedEntity.enumField={};
tabService.selectedEntity.enumField.enumFieldId=enumFieldService.selectedEntity.enumFieldId;
tabService.insert().then(function successCallBack(response) { 
enumFieldService.selectedEntity.tab=response.data;
enumFieldService.initTabList().then(function(response) {
enumFieldService.childrenList.tabList=response.data;
});
},function errorCallback(response) { 
...
enumFieldService.selectedEntity.tab=tabService.selectedEntity;
...
{
tabService.selectedEntity.show=false;
enumFieldService.selectedEntity.tab=null;
tabService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("enumEntityController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,fieldService,entityService,annotationService,annotationAttributeService,enumEntityService,projectService,enumValueService)
{
//enumField
...
enumEntityService.selectedEntity.show=false;
enumEntityService.selectedEntity.enumField={};
enumEntityService.selectedEntity.enumField.enumFieldId=enumFieldService.selectedEntity.enumFieldId;
enumEntityService.insert().then(function successCallBack(response) { 
enumFieldService.selectedEntity.enumEntity=response.data;
...
enumFieldService.selectedEntity.enumEntity=enumEntityService.selectedEntity;
...
{
enumEntityService.selectedEntity.show=false;
enumFieldService.selectedEntity.enumEntity=null;
enumEntityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()

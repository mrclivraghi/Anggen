...
restrictionFieldService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.enumEntityList.push(enumEntityService.selectedEntity);
restrictionFieldService.insert().then(function successCallBack(response) { 
enumEntityService.selectedEntity.restrictionFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumEntityService.selectedEntity.restrictionFieldList.length; i++)

{

if (enumEntityService.selectedEntity.restrictionFieldList[i].restrictionFieldId==restrictionFieldService.selectedEntity.restrictionFieldId)

enumEntityService.selectedEntity.restrictionFieldList.splice(i,1);
...
restrictionFieldService.setSelectedEntity(null);
enumEntityService.initRestrictionFieldList().then(function(response) {
enumEntityService.childrenList.restrictionFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
annotationService.selectedEntity.enumValueList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<annotationService.selectedEntity.enumValueList.length; i++)

{

if (annotationService.selectedEntity.enumValueList[i].enumValueId==enumValueService.selectedEntity.enumValueId)

annotationService.selectedEntity.enumValueList.splice(i,1);
...
enumValueService.setSelectedEntity(null);
annotationService.initEnumValueList().then(function(response) {
annotationService.childrenList.enumValueList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

...
enumFieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.fieldList.push(fieldService.selectedEntity);
enumFieldService.insert().then(function successCallBack(response) { 
fieldService.selectedEntity.enumFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<fieldService.selectedEntity.enumFieldList.length; i++)

{

if (fieldService.selectedEntity.enumFieldList[i].enumFieldId==enumFieldService.selectedEntity.enumFieldId)

fieldService.selectedEntity.enumFieldList.splice(i,1);

}

fieldService.selectedEntity.enumFieldList.push(enumFieldService.selectedEntity);
...
enumFieldService.setSelectedEntity(null);
fieldService.initEnumFieldList().then(function(response) {
fieldService.childrenList.enumFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
enumFieldService.selectedEntity.entityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumFieldService.selectedEntity.entityList.length; i++)

{

if (enumFieldService.selectedEntity.entityList[i].entityId==entityService.selectedEntity.entityId)

enumFieldService.selectedEntity.entityList.splice(i,1);

}

enumFieldService.selectedEntity.entityList.push(entityService.selectedEntity);
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.enumEntityList.push(enumEntityService.selectedEntity);
annotationService.insert().then(function successCallBack(response) { 
enumEntityService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumEntityService.selectedEntity.annotationList.length; i++)

{

if (enumEntityService.selectedEntity.annotationList[i].annotationId==annotationService.selectedEntity.annotationId)

enumEntityService.selectedEntity.annotationList.splice(i,1);

}

enumEntityService.selectedEntity.annotationList.push(annotationService.selectedEntity);
...
annotationService.setSelectedEntity(null);
enumEntityService.initAnnotationList().then(function(response) {
enumEntityService.childrenList.annotationList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
annotationAttributeService.selectedEntity.roleList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<annotationAttributeService.selectedEntity.roleList.length; i++)

{

if (annotationAttributeService.selectedEntity.roleList[i].roleId==roleService.selectedEntity.roleId)

annotationAttributeService.selectedEntity.roleList.splice(i,1);

}

annotationAttributeService.selectedEntity.roleList.push(roleService.selectedEntity);

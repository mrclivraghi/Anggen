...
var promise= $http.post("http://127.0.0.1:8080/ServerTestApp/enumField/search",this.searchBean);
return promise; 
};
this.searchOne=function(entity) {
var promise= $http.get("http://127.0.0.1:8080/ServerTestApp/enumField/"+entity.enumFieldId);
return promise; 
};
this.insert = function() {
var promise= $http.put("http://127.0.0.1:8080/ServerTestApp/enumField/",this.selectedEntity);
return promise; 
};
this.update = function() {
var promise= $http.post("http://127.0.0.1:8080/ServerTestApp/enumField/",this.selectedEntity);
return promise; 
}
this.del = function() {
var url="http://127.0.0.1:8080/ServerTestApp/enumField/"+this.selectedEntity.enumFieldId;
...
var promise= $http.post("http://127.0.0.1:8080/ServerTestApp/enumField/"+this.selectedEntity.enumFieldId+"/load"+field+"/",formData,{
...
{
var promise= $http
.post("http://127.0.0.1:8080/ServerTestApp/enumEntity/search",
{});
return promise;
};

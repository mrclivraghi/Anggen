...
entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;}
$scope.addNew= function()
{
tabService.setSelectedEntity(null);
tabService.setEntityList(null);
tabService.selectedEntity.show=true;
entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#tabTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.tabDetailForm.$valid) return; 
entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;tabService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("projectController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
tabService.selectedEntity.project=response.data;
...
tabService.selectedEntity.project=projectService.selectedEntity;
...
{
projectService.selectedEntity.show=false;
tabService.selectedEntity.project=null;
projectService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("relationshipController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
.controller("restrictionEntityController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
restrictionEntityService.selectedEntity.show=false;
restrictionEntityService.selectedEntity.tab={};
restrictionEntityService.selectedEntity.tab.tabId=tabService.selectedEntity.tabId;
...
.controller("enumFieldController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
.controller("restrictionEntityGroupController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
restrictionEntityGroupService.selectedEntity.show=false;
restrictionEntityGroupService.selectedEntity.tab={};
restrictionEntityGroupService.selectedEntity.tab.tabId=tabService.selectedEntity.tabId;
...
.controller("enumValueController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.tab={};
enumValueService.selectedEntity.tab.tabId=tabService.selectedEntity.tabId;
enumValueService.insert().then(function successCallBack(response) { 
tabService.selectedEntity.enumValueList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<tabService.selectedEntity.enumValueList.length; i++)

{

if (tabService.selectedEntity.enumValueList[i].enumValueId==enumValueService.selectedEntity.enumValueId)

tabService.selectedEntity.enumValueList.splice(i,1);
...
enumValueService.setSelectedEntity(null);
tabService.initEnumValueList().then(function(response) {
tabService.childrenList.enumValueList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("entityGroupController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
tabService.selectedEntity.entityGroup=response.data;
tabService.initEntityGroupList().then(function(response) {
tabService.childrenList.entityGroupList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
tabService.selectedEntity.entityGroup=entityGroupService.selectedEntity;
...
{
entityGroupService.selectedEntity.show=false;
tabService.selectedEntity.entityGroup=null;
entityGroupService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("roleController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
tabService.selectedEntity.role=response.data;
...
tabService.selectedEntity.role=roleService.selectedEntity;
...
{
roleService.selectedEntity.show=false;
tabService.selectedEntity.role=null;
roleService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("userController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
userService.selectedEntity.show=false;
userService.selectedEntity.tabList.push(tabService.selectedEntity);
userService.insert().then(function successCallBack(response) { 
tabService.selectedEntity.userList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<tabService.selectedEntity.userList.length; i++)

{

if (tabService.selectedEntity.userList[i].userId==userService.selectedEntity.userId)

tabService.selectedEntity.userList.splice(i,1);

}

tabService.selectedEntity.userList.push(userService.selectedEntity);
...
userService.setSelectedEntity(null);
tabService.initUserList().then(function(response) {
tabService.childrenList.userList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("annotationController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.tab={};
annotationService.selectedEntity.tab.tabId=tabService.selectedEntity.tabId;
...
.controller("restrictionFieldController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
restrictionFieldService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.tab={};
restrictionFieldService.selectedEntity.tab.tabId=tabService.selectedEntity.tabId;
...
.controller("enumEntityController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
enumEntityService.selectedEntity.show=false;
enumEntityService.selectedEntity.tabList.push(tabService.selectedEntity);
enumEntityService.insert().then(function successCallBack(response) { 
tabService.selectedEntity.enumEntity=response.data;
tabService.initEnumEntityList().then(function(response) {
tabService.childrenList.enumEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
tabService.selectedEntity.enumEntity=enumEntityService.selectedEntity;
...
{
enumEntityService.selectedEntity.show=false;
tabService.selectedEntity.enumEntity=null;
enumEntityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("fieldController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
.controller("annotationAttributeController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab
...
annotationAttributeService.selectedEntity.show=false;
annotationAttributeService.selectedEntity.tab={};
annotationAttributeService.selectedEntity.tab.tabId=tabService.selectedEntity.tabId;
annotationAttributeService.insert().then(function successCallBack(response) { 
tabService.selectedEntity.annotationAttributeList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<tabService.selectedEntity.annotationAttributeList.length; i++)

{

if (tabService.selectedEntity.annotationAttributeList[i].annotationAttributeId==annotationAttributeService.selectedEntity.annotationAttributeId)

tabService.selectedEntity.annotationAttributeList.splice(i,1);
...
annotationAttributeService.setSelectedEntity(null);
tabService.initAnnotationAttributeList().then(function(response) {
tabService.childrenList.annotationAttributeList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("entityController",function($scope,$http,tabService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,annotationService,relationshipService,enumFieldService,annotationAttributeService,userService)
{
//tab

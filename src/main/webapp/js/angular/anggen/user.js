...
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;}
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.user={};
entityService.selectedEntity.user.userId=userService.selectedEntity.userId;
entityService.insert().then(function successCallBack(response) { 
userService.selectedEntity.entityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<userService.selectedEntity.entityList.length; i++)

{

if (userService.selectedEntity.entityList[i].entityId==entityService.selectedEntity.entityId)

userService.selectedEntity.entityList.splice(i,1);

}

userService.selectedEntity.entityList.push(entityService.selectedEntity);
...
fieldService.selectedEntity.show=false;
fieldService.selectedEntity.user={};
fieldService.selectedEntity.user.userId=userService.selectedEntity.userId;
fieldService.insert().then(function successCallBack(response) { 
userService.selectedEntity.fieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<userService.selectedEntity.fieldList.length; i++)

{

if (userService.selectedEntity.fieldList[i].fieldId==fieldService.selectedEntity.fieldId)

userService.selectedEntity.fieldList.splice(i,1);
...
userService.selectedEntity.tab=response.data;
...
userService.selectedEntity.tab=tabService.selectedEntity;
...
{
tabService.selectedEntity.show=false;
userService.selectedEntity.tab=null;
tabService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()

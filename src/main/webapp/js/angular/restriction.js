var restrictionApp=angular.module("restrictionApp",['ngTouch', 'ui.grid', 'ui.grid.pagination','ui.grid.selection','ui.date', 'ui.grid.exporter'])
...
roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;userService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;}
$scope.addNew= function()
{
restrictionService.setSelectedEntity(null);
restrictionService.setEntityList(null);
restrictionService.selectedEntity.show=true;
roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;userService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;$('#restrictionTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.restrictionDetailForm.$valid) return; 
roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;userService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
$scope.del=function()
{
nullService.selectedEntity.restriction=null;
...
$scope.restrictionGridOptions.onRegisterApi = function(gridApi){

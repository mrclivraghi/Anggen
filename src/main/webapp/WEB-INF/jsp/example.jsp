				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="example-Detail">
							...
							<div class="pull-left right-input"
								ng-class="{&#39;has-error&#39;: !exampleDetailForm.exampleFile.$valid, &#39;has-success&#39;: exampleDetailForm.exampleFile.$valid}"
								style="height: 59px" ng-show="true ">
								<div class="input-group">
									<span class="input-group-addon">exampleFile</span>
									<div tabindex="500"
										class="form-control file-caption  kv-fileinput-caption">
										<div class="file-caption-name" title="">
											<span class="glyphicon glyphicon-file kv-caption-icon"></span>{{selectedEntity.exampleFile}}
										</div>
									</div>
									<div class="input-group-btn">
										<button ng-click="loadFile(null,&#39;ExampleFile&#39;)"
											type="button" tabindex="500" title="Clear selected files"
										...
										<div class="btn btn-primary btn-file"
											ngf-select="loadFile($file,&#39;ExampleFile&#39;)"
											ng-if="selectedEntity.exampleFile==undefined"
											>
											<i class="glyphicon glyphicon-folder-open"></i>
											<span >Browse</span>
										</div>
										<div class="btn btn-primary"
											onclick="openFile(selectedEntity.exampleFile)"
											ng-if="selectedEntity.exampleFile!=undefined"
											>
											<i class="glyphicon glyphicon-folder-open"></i>
											<span>Open</span>
							...
							<div class="pull-left right-input"
								ng-class="{&#39;has-error&#39;: !exampleDetailForm.file2.$valid, &#39;has-success&#39;: exampleDetailForm.file2.$valid}"
								style="height: 59px" ng-show="true ">
								<div class="input-group">
									<span class="input-group-addon">file2</span>
									<div tabindex="500"
										class="form-control file-caption  kv-fileinput-caption">
										<div class="file-caption-name" title="">
											<span class="glyphicon glyphicon-file kv-caption-icon"></span>{{selectedEntity.file2}}
										</div>
									</div>
									<div class="input-group-btn">
										<button ng-click="loadFile(null,&#39;File2&#39;)"
											type="button" tabindex="500" title="Clear selected files"
											class="btn btn-default fileinput-remove fileinput-remove-button">
											<i class="glyphicon glyphicon-trash"></i><span
												class="hidden-xs">Remove</span>
										...
										<div class="btn btn-primary btn-file"
											ngf-select="loadFile($file,&#39;File2&#39;)">
				...
				<div class="panel-body">
					<ul class="nav nav-tabs" role="tablist" id="placeTabs">
						<li role="presentation"><a href="#place-Detail"
							aria-controls="Detail" role="tab" data-toggle="tab"
							ng-click="refreshTableDetail()">Detail</a></li>
						<script type="text/javascript">$('a[href="#place-Detail"]').on('shown.bs.tab', function (e) {
var target = $(e.target).attr("href"); // activated tab
//console.log(target);
if (angular.element($('#placeTabs')).scope()!=null && angular.element($('#placeTabs')).scope()!=undefined) 
angular.element($('#placeTabs')).scope().refreshTableDetail();
});
</script>
					</ul>
					<div class="tab-content">

...
enumValueService.selectedEntity.projectList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.projectList.length; i++)

{

if (enumValueService.selectedEntity.projectList[i].projectId==projectService.selectedEntity.projectId)

enumValueService.selectedEntity.projectList.splice(i,1);

...
entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;}
$scope.addNew= function()
{
tabService.setSelectedEntity(null);
tabService.setEntityList(null);
tabService.selectedEntity.show=true;
entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;$('#tabTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.tabDetailForm.$valid) return; 
entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;if (row.isSelected)
{
...
enumService.selectedEntity.show=false;
enumService.selectedEntity.tabList.push(tabService.selectedEntity);
...
restrictionService.selectedEntity.show=false;
restrictionService.selectedEntity.tabList.push(tabService.selectedEntity);

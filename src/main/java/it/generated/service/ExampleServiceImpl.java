    ...
    implements ExampleService
{
    ...
    public List<it.generated.domain.Example> find(ExampleSearchBean example) {
        return exampleRepository.findByExampleIdAndExampleDateAndAgeAndMaleAndPlaceAndPlaceName(example.getExampleId(),it.polimi.utils.Utility.formatDate(example.getExampleDate()),example.getAge(),example.getMale(),example.getPlaceList()==null? null :example.getPlaceList().get(0),example.getPlacePlaceName());
    }

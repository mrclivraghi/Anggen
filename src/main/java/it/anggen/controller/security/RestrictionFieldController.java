...
public class RestrictionFieldController {
    ...
    @ApiOperation(value = "Return a page of restrictionField", notes = "Return a single page of restrictionField", response = it.anggen.model.security.RestrictionField.class, responseContainer = "List")
    @Timed
    ...
    @ApiOperation(value = "Return a list of restrictionField", notes = "Return a list of restrictionField based on the search bean requested", response = it.anggen.model.security.RestrictionField.class, responseContainer = "List")
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Return a the restrictionField identified by the given id", notes = "Return a the restrictionField identified by the given id", response = it.anggen.model.security.RestrictionField.class, responseContainer = "List")
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Delete the restrictionField identified by the given id", notes = "Delete the restrictionField identified by the given id")
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Insert the restrictionField given", notes = "Insert the restrictionField given ", response = it.anggen.model.security.RestrictionField.class)
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Update the restrictionField given", notes = "Update the restrictionField given ", response = it.anggen.model.security.RestrictionField.class)
    @Timed
    @ResponseBody

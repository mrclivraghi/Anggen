...
.run(function($rootScope,securityService,restrictionFieldService, securityService ,fieldService,roleService,entityService,annotationService,tabService,userService,restrictionEntityService,restrictionEntityGroupService){
...
fieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;}
$scope.addNew= function()
{
restrictionService.setSelectedEntity(null);
restrictionService.setEntityList(null);
restrictionService.selectedEntity.show=true;
fieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;$('#restrictionFieldTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.restrictionFieldDetailForm.$valid) return; 
fieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
fieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;if (row.isSelected)
{
...
restrictionService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<restrictionService.selectedEntity.annotationList.length; i++)
...
restrictionService.selectedEntity.show=false;
restrictionService.selectedEntity.restrictionFieldList.push(restrictionFieldService.selectedEntity);
restrictionService.insert().then(function successCallBack(response) { 
restrictionService.selectedEntity.restrictionEntityList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<restrictionService.selectedEntity.restrictionEntityList.length; i++)

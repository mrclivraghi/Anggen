...
roleService.selectedEntity.show=false;restrictionService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;}
$scope.addNew= function()
{
userService.setSelectedEntity(null);
userService.setEntityList(null);
userService.selectedEntity.show=true;
roleService.selectedEntity.show=false;restrictionService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;$('#userTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.userDetailForm.$valid) return; 
roleService.selectedEntity.show=false;restrictionService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;userService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
roleService.selectedEntity.show=false;restrictionService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;if (row.isSelected)
{
...
restrictionService.selectedEntity.show=false;
restrictionService.selectedEntity.role={};
restrictionService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
restrictionService.insert().then(function successCallBack(response) { 
roleService.selectedEntity.restrictionList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<roleService.selectedEntity.restrictionList.length; i++)

{

if (roleService.selectedEntity.restrictionList[i].restrictionId==restrictionService.selectedEntity.restrictionId)

roleService.selectedEntity.restrictionList.splice(i,1);

}

roleService.selectedEntity.restrictionList.push(restrictionService.selectedEntity);
...
restrictionService.setSelectedEntity(null);
roleService.initRestrictionList().then(function(response) {
roleService.childrenList.restrictionList=response.data;
});
},function errorCallback(response) { 
alert("error");
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.restriction={};
entityService.selectedEntity.restriction.restrictionId=restrictionService.selectedEntity.restrictionId;
entityService.insert().then(function successCallBack(response) { 
restrictionService.selectedEntity.entity=response.data;
restrictionService.initEntityList().then(function(response) {
restrictionService.childrenList.entityList=response.data;
});
},function errorCallback(response) { 
alert("error");
...
restrictionService.selectedEntity.entity=entityService.selectedEntity;
...
{
entityService.selectedEntity.show=false;
restrictionService.selectedEntity.entity=null;
entityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()

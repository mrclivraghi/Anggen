...
restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#entityTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.entityDetailForm.$valid) return; 
restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;entityService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("projectController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
entityService.selectedEntity.project=response.data;
...
entityService.selectedEntity.project=projectService.selectedEntity;
...
{
projectService.selectedEntity.show=false;
entityService.selectedEntity.project=null;
projectService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("restrictionEntityController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
.controller("enumValueController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.entity={};
enumValueService.selectedEntity.entity.entityId=entityService.selectedEntity.entityId;
enumValueService.insert().then(function successCallBack(response) { 
entityService.selectedEntity.enumValueList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityService.selectedEntity.enumValueList.length; i++)

{

if (entityService.selectedEntity.enumValueList[i].enumValueId==enumValueService.selectedEntity.enumValueId)

entityService.selectedEntity.enumValueList.splice(i,1);
...
enumValueService.setSelectedEntity(null);
entityService.initEnumValueList().then(function(response) {
entityService.childrenList.enumValueList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("entityGroupController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
entityService.selectedEntity.entityGroupList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityService.selectedEntity.entityGroupList.length; i++)

{

if (entityService.selectedEntity.entityGroupList[i].entityGroupId==entityGroupService.selectedEntity.entityGroupId)

entityService.selectedEntity.entityGroupList.splice(i,1);
...
restrictionEntityGroupService.selectedEntity.show=false;
restrictionEntityGroupService.selectedEntity.entity={};
restrictionEntityGroupService.selectedEntity.entity.entityId=entityService.selectedEntity.entityId;
...
.controller("userController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
entityService.selectedEntity.userList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityService.selectedEntity.userList.length; i++)

{

if (entityService.selectedEntity.userList[i].userId==userService.selectedEntity.userId)

entityService.selectedEntity.userList.splice(i,1);
...
userService.setSelectedEntity(null);
entityService.initUserList().then(function(response) {
entityService.childrenList.userList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("annotationController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.entity={};
annotationService.selectedEntity.entity.entityId=entityService.selectedEntity.entityId;
annotationService.insert().then(function successCallBack(response) { 
entityService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityService.selectedEntity.annotationList.length; i++)

{

if (entityService.selectedEntity.annotationList[i].annotationId==annotationService.selectedEntity.annotationId)

entityService.selectedEntity.annotationList.splice(i,1);
...
annotationService.setSelectedEntity(null);
entityService.initAnnotationList().then(function(response) {
entityService.childrenList.annotationList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("tabController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
entityService.selectedEntity.tab=response.data;
...
entityService.selectedEntity.tab=tabService.selectedEntity;
...
{
tabService.selectedEntity.show=false;
entityService.selectedEntity.tab=null;
tabService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("roleController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
entityService.selectedEntity.role=response.data;
...
entityService.selectedEntity.role=roleService.selectedEntity;
...
{
roleService.selectedEntity.show=false;
entityService.selectedEntity.role=null;
roleService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("restrictionFieldController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
restrictionFieldService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.entity={};
restrictionFieldService.selectedEntity.entity.entityId=entityService.selectedEntity.entityId;
...
.controller("relationshipController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
.controller("enumEntityController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
entityService.selectedEntity.enumEntity=response.data;
...
entityService.selectedEntity.enumEntity=enumEntityService.selectedEntity;
...
{
enumEntityService.selectedEntity.show=false;
entityService.selectedEntity.enumEntity=null;
enumEntityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
annotationAttributeService.selectedEntity.show=false;
annotationAttributeService.selectedEntity.entity={};
annotationAttributeService.selectedEntity.entity.entityId=entityService.selectedEntity.entityId;
...
.controller("fieldController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
entityService.selectedEntity.field=response.data;
...
entityService.selectedEntity.field=fieldService.selectedEntity;
...
{
fieldService.selectedEntity.show=false;
entityService.selectedEntity.field=null;
fieldService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("enumFieldController",function($scope,$http,entityService, securityService ,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//entity
...
entityService.selectedEntity.enumField=response.data;
...
entityService.selectedEntity.enumField=enumFieldService.selectedEntity;
...
{
enumFieldService.selectedEntity.show=false;
entityService.selectedEntity.enumField=null;
enumFieldService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()

...
.run(function($rootScope,securityService,annotationService, securityService ,fieldService,relationshipService,enumFieldService,annotationAttributeService,entityService,restrictionFieldService,tabService,entityService,entityService,tabService,enumValueService,entityService,tabService){
...
fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;tabService.selectedEntity.show=false;}
$scope.addNew= function()
{
annotationService.setSelectedEntity(null);
annotationService.setEntityList(null);
annotationService.selectedEntity.show=true;
fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;tabService.selectedEntity.show=false;$('#annotationTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.annotationDetailForm.$valid) return; 
fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
enumService.selectedEntity.show=false;
enumService.selectedEntity.annotationList.push(annotationService.selectedEntity);
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.annotationList.push(annotationService.selectedEntity);
annotationService.insert().then(function successCallBack(response) { 
...
restrictionService.selectedEntity.show=false;
restrictionService.selectedEntity.annotationList.push(annotationService.selectedEntity);

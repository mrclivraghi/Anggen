var enumFieldApp=angular.module("enumFieldApp",['ngFileUpload','ngTouch', 'ui.grid', 'ui.grid.pagination','ui.grid.selection','ui.date', 'ui.grid.exporter'])
...
,data: enumFieldService.entityList
 };
...
enumFieldService.selectedEntity.restrictionFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumFieldService.selectedEntity.restrictionFieldList.length; i++)

{

if (enumFieldService.selectedEntity.restrictionFieldList[i].restrictionFieldId==restrictionFieldService.selectedEntity.restrictionFieldId)

enumFieldService.selectedEntity.restrictionFieldList.splice(i,1);

}

enumFieldService.selectedEntity.restrictionFieldList.push(restrictionFieldService.selectedEntity);
...
restrictionFieldService.setSelectedEntity(null);
enumFieldService.initRestrictionFieldList().then(function(response) {
enumFieldService.childrenList.restrictionFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.enumValueList.push(enumValueService.selectedEntity);
annotationService.insert().then(function successCallBack(response) { 
enumValueService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.annotationList.length; i++)

{

if (enumValueService.selectedEntity.annotationList[i].annotationId==annotationService.selectedEntity.annotationId)

enumValueService.selectedEntity.annotationList.splice(i,1);

}

enumValueService.selectedEntity.annotationList.push(annotationService.selectedEntity);
...
annotationService.setSelectedEntity(null);
enumValueService.initAnnotationList().then(function(response) {
enumValueService.childrenList.annotationList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.annotationList.push(annotationService.selectedEntity);
entityService.insert().then(function successCallBack(response) { 
annotationService.selectedEntity.entityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<annotationService.selectedEntity.entityList.length; i++)

{

if (annotationService.selectedEntity.entityList[i].entityId==entityService.selectedEntity.entityId)

annotationService.selectedEntity.entityList.splice(i,1);

}

annotationService.selectedEntity.entityList.push(entityService.selectedEntity);
...
entityService.setSelectedEntity(null);
annotationService.initEntityList().then(function(response) {
annotationService.childrenList.entityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
relationshipService.selectedEntity.show=false;
relationshipService.selectedEntity.userList.push(userService.selectedEntity);
relationshipService.insert().then(function successCallBack(response) { 
userService.selectedEntity.relationshipList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<userService.selectedEntity.relationshipList.length; i++)

{

if (userService.selectedEntity.relationshipList[i].relationshipId==relationshipService.selectedEntity.relationshipId)

userService.selectedEntity.relationshipList.splice(i,1);

}

userService.selectedEntity.relationshipList.push(relationshipService.selectedEntity);
...
relationshipService.setSelectedEntity(null);
userService.initRelationshipList().then(function(response) {
userService.childrenList.relationshipList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

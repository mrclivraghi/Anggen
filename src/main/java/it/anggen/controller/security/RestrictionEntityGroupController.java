...
public class RestrictionEntityGroupController {
    ...
    @ApiOperation(value = "Return a page of restrictionEntityGroup", notes = "Return a single page of restrictionEntityGroup", response = it.anggen.model.security.RestrictionEntityGroup.class, responseContainer = "List")
    @Timed
    ...
    @ApiOperation(value = "Return a list of restrictionEntityGroup", notes = "Return a list of restrictionEntityGroup based on the search bean requested", response = it.anggen.model.security.RestrictionEntityGroup.class, responseContainer = "List")
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Return a the restrictionEntityGroup identified by the given id", notes = "Return a the restrictionEntityGroup identified by the given id", response = it.anggen.model.security.RestrictionEntityGroup.class, responseContainer = "List")
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Delete the restrictionEntityGroup identified by the given id", notes = "Delete the restrictionEntityGroup identified by the given id")
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Insert the restrictionEntityGroup given", notes = "Insert the restrictionEntityGroup given ", response = it.anggen.model.security.RestrictionEntityGroup.class)
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Update the restrictionEntityGroup given", notes = "Update the restrictionEntityGroup given ", response = it.anggen.model.security.RestrictionEntityGroup.class)
    @Timed
    @ResponseBody

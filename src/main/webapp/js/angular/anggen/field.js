var fieldApp=angular.module("fieldApp",['ngFileUpload','ngTouch', 'ui.grid', 'ui.grid.pagination','ui.grid.selection','ui.date', 'ui.grid.exporter'])
...
tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;}
$scope.addNew= function()
{
fieldService.setSelectedEntity(null);
fieldService.setEntityList(null);
fieldService.selectedEntity.show=true;
tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;$('#fieldTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.fieldDetailForm.$valid) return; 
tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;fieldService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;if (row.isSelected)
{
...
fieldService.selectedEntity.tabList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<fieldService.selectedEntity.tabList.length; i++)

{

if (fieldService.selectedEntity.tabList[i].tabId==tabService.selectedEntity.tabId)

fieldService.selectedEntity.tabList.splice(i,1);

}

fieldService.selectedEntity.tabList.push(tabService.selectedEntity);
...
enumFieldService.selectedEntity.entityGroupList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumFieldService.selectedEntity.entityGroupList.length; i++)

{

if (enumFieldService.selectedEntity.entityGroupList[i].entityGroupId==entityGroupService.selectedEntity.entityGroupId)

enumFieldService.selectedEntity.entityGroupList.splice(i,1);

}

enumFieldService.selectedEntity.entityGroupList.push(entityGroupService.selectedEntity);
...
entityGroupService.setSelectedEntity(null);
enumFieldService.initEntityGroupList().then(function(response) {
enumFieldService.childrenList.entityGroupList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
userService.selectedEntity.annotationAttributeList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<userService.selectedEntity.annotationAttributeList.length; i++)

{

if (userService.selectedEntity.annotationAttributeList[i].annotationAttributeId==annotationAttributeService.selectedEntity.annotationAttributeId)

userService.selectedEntity.annotationAttributeList.splice(i,1);
...
annotationAttributeService.setSelectedEntity(null);
userService.initAnnotationAttributeList().then(function(response) {
userService.childrenList.annotationAttributeList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.annotationAttributeList.push(annotationAttributeService.selectedEntity);

...
.run(function($rootScope,securityService,annotationService, securityService ,annotationAttributeService,fieldService,entityService,relationshipService,tabService,enumFieldService,enumValueService,restrictionEntityService,roleService,userService,restrictionFieldService,restrictionEntityGroupService,entityGroupService,projectService){
...
annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;}
$scope.addNew= function()
{
annotationService.setSelectedEntity(null);
annotationService.setEntityList(null);
annotationService.selectedEntity.show=true;
annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;$('#annotationTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.annotationDetailForm.$valid) return; 
annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;annotationService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;if (row.isSelected)
{
...
if (annotationService.selectedEntity.relationshipList[i].relationshipId==relationshipService.selectedEntity.relationshipId)

annotationService.selectedEntity.relationshipList.splice(i,1);
...
annotationService.selectedEntity.entityGroupList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<annotationService.selectedEntity.entityGroupList.length; i++)

{

if (annotationService.selectedEntity.entityGroupList[i].entityGroupId==entityGroupService.selectedEntity.entityGroupId)

annotationService.selectedEntity.entityGroupList.splice(i,1);
...
annotationService.selectedEntity.projectList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<annotationService.selectedEntity.projectList.length; i++)

{

if (annotationService.selectedEntity.projectList[i].projectId==projectService.selectedEntity.projectId)

annotationService.selectedEntity.projectList.splice(i,1);

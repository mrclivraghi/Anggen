...
enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;}
$scope.addNew= function()
{
enumService.setSelectedEntity(null);
enumService.setEntityList(null);
enumService.selectedEntity.show=true;
enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;$('#enumFieldTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.enumFieldDetailForm.$valid) return; 
enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;if (row.isSelected)
{
enumService.setSelectedEntity(row.entity);
...
.controller("enumValueController",function($scope,$http,enumValueService, securityService ,enumFieldService,entityService,annotationService,tabService)
{
//enumField
$scope.searchBean=enumService.searchBean;
$scope.entityList=enumService.entityList;
...
{
enumService.resetSearchBean();
$scope.searchBean=enumValueService.searchBean;enumService.setSelectedEntity(null);
enumService.selectedEntity.show=false;
enumService.setEntityList(null); 
}
...
enumService.setSelectedEntity(response);
if (toDo != null)
toDo();
},function errorCallback(response) {      
alert("error");
...
enumService.selectedEntity.show=false;
enumService.selectedEntity.enumFieldList.push(enumFieldService.selectedEntity);
enumService.insert().then(function successCallBack(response) { 
enumService.selectedEntity.enumValueList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumService.selectedEntity.enumValueList.length; i++)
...
{
if (enumService.selectedEntity.enumField==null || enumValueService.selectedEntity.enumField==undefined)
{
if (securityService.restrictionList.enumValue==undefined || securityService.restrictionList.enumValue.canSearch)
enumFieldService.initEnumValueList().then(function successCallback(response) {
enumFieldService.childrenList.enumValueList=response.data;
...
enumService.searchOne(enumValueService.selectedEntity.enumField).then(
function successCallback(response) {
if (securityService.restrictionList.enumValue==undefined || securityService.restrictionList.enumValue.canSearch)
enumFieldService.initEnumValueList().then(function successCallback(response) {
enumFieldService.childrenList.enumValueList=response.data;
...
enumService.selectedEntity.entityList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumService.selectedEntity.entityList.length; i++)
...
enumService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumService.selectedEntity.annotationList.length; i++)
...
enumService.selectedEntity.tabList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumService.selectedEntity.tabList.length; i++)
...
enumService.selectedEntity.fieldList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumService.selectedEntity.fieldList.length; i++)
...
enumService.selectedEntity.relationshipList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumService.selectedEntity.relationshipList.length; i++)
...
restrictionService.selectedEntity.show=false;
restrictionService.selectedEntity.enumFieldList.push(enumFieldService.selectedEntity);
restrictionService.insert().then(function successCallBack(response) { 
enumService.selectedEntity.restrictionEntityList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumService.selectedEntity.restrictionEntityList.length; i++)
...
entityService.selectedEntity.enumFieldList.push(enumFieldService.selectedEntity);
entityService.insert().then(function successCallBack(response) { 
enumService.selectedEntity.entityGroupList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumService.selectedEntity.entityGroupList.length; i++)
...
annotationService.selectedEntity.enumFieldList.push(enumFieldService.selectedEntity);
annotationService.insert().then(function successCallBack(response) { 
enumService.selectedEntity.annotationAttributeList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumService.selectedEntity.annotationAttributeList.length; i++)

...
public class RelationshipController {
    ...
    @ApiOperation(value = "Return a page of relationship", notes = "Return a single page of relationship", response = it.anggen.model.relationship.Relationship.class, responseContainer = "List")
    @Timed
    ...
    @ApiOperation(value = "Return a list of relationship", notes = "Return a list of relationship based on the search bean requested", response = it.anggen.model.relationship.Relationship.class, responseContainer = "List")
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Return a the relationship identified by the given id", notes = "Return a the relationship identified by the given id", response = it.anggen.model.relationship.Relationship.class, responseContainer = "List")
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Delete the relationship identified by the given id", notes = "Delete the relationship identified by the given id")
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Insert the relationship given", notes = "Insert the relationship given ", response = it.anggen.model.relationship.Relationship.class)
    @Timed
    @ResponseBody
...
return ResponseEntity.status(org.springframework.http.HttpStatus.FORBIDDEN).build(); 
    ...
    @ApiOperation(value = "Update the relationship given", notes = "Update the relationship given ", response = it.anggen.model.relationship.Relationship.class)
    @Timed
    @ResponseBody

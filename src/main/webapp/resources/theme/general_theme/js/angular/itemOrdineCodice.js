...
itemOrdineCodiceService.insert().then(function(data) { 
$scope.search();
});
};
...
{
if (!$scope.itemOrdineCodiceDetailForm.$valid) return; 
itemOrdineService.selectedEntity.show=false;ordineService.selectedEntity.show=false;colloService.selectedEntity.show=false;itemOrdineCodiceService.update().then(function(data) { 
$scope.search();
});
};
$scope.del=function()

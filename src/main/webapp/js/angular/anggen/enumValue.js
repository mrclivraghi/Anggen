...
.run(function($rootScope,securityService,enumValueService, securityService ,enumFieldService,entityService,annotationService,tabService){
...
enumFieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;}
$scope.addNew= function()
{
enumService.setSelectedEntity(null);
enumService.setEntityList(null);
enumService.selectedEntity.show=true;
enumFieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;$('#enumValueTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.enumValueDetailForm.$valid) return; 
enumFieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
enumFieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;if (row.isSelected)
{
...
enumService.selectedEntity.show=false;
enumService.selectedEntity.enumValueList.push(enumValueService.selectedEntity);
enumService.insert().then(function successCallBack(response) { 
enumService.selectedEntity.enumFieldList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumService.selectedEntity.enumFieldList.length; i++)

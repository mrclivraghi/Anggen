    ...
    implements EntityService
{
    ...
    public List<it.anggen.model.entity.Entity> find(EntitySearchBean entity) {
        return entityRepository.(entity.getEntityId(),entity.getGenerateFrontEnd(),entity.getName(),entity.getCache(),entity.getDisableViewGeneration(),entity.getDescendantMaxLevel(),entity.getEnableRestrictionData(),entity.getIgnoreMenu(),it.anggen.utils.Utility.formatDate(entity.getAddDate()),it.anggen.utils.Utility.formatDate(entity.getModDate()), (entity.getSecurityType()==null)? null : entity.getSecurityType().getValue(), (entity.getGenerationType()==null)? null : entity.getGenerationType().getValue(),entity.getRestrictionEntityList()==null? null :entity.getRestrictionEntityList().get(0),entity.getFieldList()==null? null :entity.getFieldList().get(0),entity.getEnumFieldList()==null? null :entity.getEnumFieldList().get(0),entity.getEntityGroup(),entity.getTabList()==null? null :entity.getTabList().get(0),entity.getRelationshipList()==null? null :entity.getRelationshipList().get(0));
    }

...
.run(function($rootScope,securityService,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,annotationAttributeService,restrictionFieldService,roleService,restrictionEntityGroupService,restrictionEntityService,userService){
...
.controller("enumValueController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,annotationAttributeService,restrictionFieldService,roleService,restrictionEntityGroupService,restrictionEntityService,userService)
{
//null
...
{
if (!$scope.enumValueDetailForm.$valid) return; 
enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;enumValueService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
fieldService.selectedEntity.show=false;
fieldService.selectedEntity.enumValue={};
fieldService.selectedEntity.enumValue.enumValueId=enumValueService.selectedEntity.enumValueId;
...
tabService.selectedEntity.show=false;
tabService.selectedEntity.enumValueList.push(enumValueService.selectedEntity);
tabService.insert().then(function successCallBack(response) { 
enumValueService.selectedEntity.tab=response.data;
...
enumValueService.selectedEntity.tab=tabService.selectedEntity;
...
{
tabService.selectedEntity.show=false;
enumValueService.selectedEntity.tab=null;
tabService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()

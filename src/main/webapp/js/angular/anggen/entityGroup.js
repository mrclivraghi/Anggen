var entityGroupApp=angular.module("entityGroupApp",['ngFileUpload','ngTouch', 'ui.grid', 'ui.grid.pagination','ui.grid.selection','ui.date', 'ui.grid.exporter'])
...
.run(function($rootScope,securityService,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService){
...
entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;}
$scope.addNew= function()
{
entityGroupService.setSelectedEntity(null);
entityGroupService.setEntityList(null);
entityGroupService.selectedEntity.show=true;
entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#entityGroupTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.entityGroupDetailForm.$valid) return; 
entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;entityGroupService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
,data: entityGroupService.entityList
 };
...
entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("tabController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
tabService.selectedEntity.show=false;
tabService.selectedEntity.entityGroup={};
tabService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
tabService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.tabList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.tabList.length; i++)

{

if (entityGroupService.selectedEntity.tabList[i].tabId==tabService.selectedEntity.tabId)

entityGroupService.selectedEntity.tabList.splice(i,1);

}

entityGroupService.selectedEntity.tabList.push(tabService.selectedEntity);
...
tabService.setSelectedEntity(null);
entityGroupService.initTabList().then(function(response) {
entityGroupService.childrenList.tabList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("restrictionFieldController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
restrictionFieldService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.entityGroup={};
restrictionFieldService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
restrictionFieldService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.restrictionFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.restrictionFieldList.length; i++)

{

if (entityGroupService.selectedEntity.restrictionFieldList[i].restrictionFieldId==restrictionFieldService.selectedEntity.restrictionFieldId)

entityGroupService.selectedEntity.restrictionFieldList.splice(i,1);
...
restrictionFieldService.setSelectedEntity(null);
entityGroupService.initRestrictionFieldList().then(function(response) {
entityGroupService.childrenList.restrictionFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("enumFieldController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
enumFieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.entityGroup={};
enumFieldService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
enumFieldService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.enumFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.enumFieldList.length; i++)

{

if (entityGroupService.selectedEntity.enumFieldList[i].enumFieldId==enumFieldService.selectedEntity.enumFieldId)

entityGroupService.selectedEntity.enumFieldList.splice(i,1);

}

entityGroupService.selectedEntity.enumFieldList.push(enumFieldService.selectedEntity);
...
enumFieldService.setSelectedEntity(null);
entityGroupService.initEnumFieldList().then(function(response) {
entityGroupService.childrenList.enumFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("enumValueController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.entityGroup={};
enumValueService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
enumValueService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.enumValueList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.enumValueList.length; i++)

{

if (entityGroupService.selectedEntity.enumValueList[i].enumValueId==enumValueService.selectedEntity.enumValueId)

entityGroupService.selectedEntity.enumValueList.splice(i,1);

}

entityGroupService.selectedEntity.enumValueList.push(enumValueService.selectedEntity);
...
enumValueService.setSelectedEntity(null);
entityGroupService.initEnumValueList().then(function(response) {
entityGroupService.childrenList.enumValueList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("annotationAttributeController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
annotationAttributeService.selectedEntity.show=false;
annotationAttributeService.selectedEntity.entityGroup={};
annotationAttributeService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
annotationAttributeService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.annotationAttributeList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.annotationAttributeList.length; i++)

{

if (entityGroupService.selectedEntity.annotationAttributeList[i].annotationAttributeId==annotationAttributeService.selectedEntity.annotationAttributeId)

entityGroupService.selectedEntity.annotationAttributeList.splice(i,1);
...
annotationAttributeService.setSelectedEntity(null);
entityGroupService.initAnnotationAttributeList().then(function(response) {
entityGroupService.childrenList.annotationAttributeList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("roleController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
entityGroupService.selectedEntity.role=response.data;
entityGroupService.initRoleList().then(function(response) {
entityGroupService.childrenList.roleList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
entityGroupService.selectedEntity.role=roleService.selectedEntity;
...
{
roleService.selectedEntity.show=false;
entityGroupService.selectedEntity.role=null;
roleService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("enumEntityController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
entityGroupService.selectedEntity.enumEntity=response.data;
entityGroupService.initEnumEntityList().then(function(response) {
entityGroupService.childrenList.enumEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
entityGroupService.selectedEntity.enumEntity=enumEntityService.selectedEntity;
...
{
enumEntityService.selectedEntity.show=false;
entityGroupService.selectedEntity.enumEntity=null;
enumEntityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("annotationController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.entityGroup={};
annotationService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
annotationService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.annotationList.length; i++)

{

if (entityGroupService.selectedEntity.annotationList[i].annotationId==annotationService.selectedEntity.annotationId)

entityGroupService.selectedEntity.annotationList.splice(i,1);

}

entityGroupService.selectedEntity.annotationList.push(annotationService.selectedEntity);
...
annotationService.setSelectedEntity(null);
entityGroupService.initAnnotationList().then(function(response) {
entityGroupService.childrenList.annotationList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("projectController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
entityGroupService.selectedEntity.project=response.data;
...
entityGroupService.selectedEntity.project=projectService.selectedEntity;
...
{
projectService.selectedEntity.show=false;
entityGroupService.selectedEntity.project=null;
projectService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("restrictionEntityGroupController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
restrictionEntityGroupService.selectedEntity.show=false;
restrictionEntityGroupService.selectedEntity.entityGroup={};
restrictionEntityGroupService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
restrictionEntityGroupService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.restrictionEntityGroupList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.restrictionEntityGroupList.length; i++)

{

if (entityGroupService.selectedEntity.restrictionEntityGroupList[i].restrictionEntityGroupId==restrictionEntityGroupService.selectedEntity.restrictionEntityGroupId)

entityGroupService.selectedEntity.restrictionEntityGroupList.splice(i,1);
...
.controller("entityController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.entityGroup={};
entityService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
entityService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.entityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.entityList.length; i++)

{

if (entityGroupService.selectedEntity.entityList[i].entityId==entityService.selectedEntity.entityId)

entityGroupService.selectedEntity.entityList.splice(i,1);

}

entityGroupService.selectedEntity.entityList.push(entityService.selectedEntity);
...
.controller("userController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
userService.selectedEntity.show=false;
userService.selectedEntity.entityGroupList.push(entityGroupService.selectedEntity);
userService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.userList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.userList.length; i++)

{

if (entityGroupService.selectedEntity.userList[i].userId==userService.selectedEntity.userId)

entityGroupService.selectedEntity.userList.splice(i,1);

}

entityGroupService.selectedEntity.userList.push(userService.selectedEntity);
...
userService.setSelectedEntity(null);
entityGroupService.initUserList().then(function(response) {
entityGroupService.childrenList.userList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("fieldController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
fieldService.selectedEntity.show=false;
fieldService.selectedEntity.entityGroup={};
fieldService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
fieldService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.fieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.fieldList.length; i++)

{

if (entityGroupService.selectedEntity.fieldList[i].fieldId==fieldService.selectedEntity.fieldId)

entityGroupService.selectedEntity.fieldList.splice(i,1);

}

entityGroupService.selectedEntity.fieldList.push(fieldService.selectedEntity);
...
fieldService.setSelectedEntity(null);
entityGroupService.initFieldList().then(function(response) {
entityGroupService.childrenList.fieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("restrictionEntityController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
restrictionEntityService.selectedEntity.show=false;
restrictionEntityService.selectedEntity.entityGroup={};
restrictionEntityService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
...
.controller("relationshipController",function($scope,$http,entityGroupService, securityService ,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//entityGroup
...
relationshipService.selectedEntity.show=false;
relationshipService.selectedEntity.entityGroup={};
relationshipService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
relationshipService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.relationshipList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.relationshipList.length; i++)

{

if (entityGroupService.selectedEntity.relationshipList[i].relationshipId==relationshipService.selectedEntity.relationshipId)

entityGroupService.selectedEntity.relationshipList.splice(i,1);

}

entityGroupService.selectedEntity.relationshipList.push(relationshipService.selectedEntity);

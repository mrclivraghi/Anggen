var tabApp=angular.module("tabApp",['ngFileUpload','ngTouch', 'ui.grid', 'ui.grid.pagination','ui.grid.selection','ui.date', 'ui.grid.exporter'])
...
.run(function($rootScope,securityService,tabService, securityService ,enumFieldService,annotationService,relationshipService,entityService,fieldService,restrictionFieldService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityService,userService,annotationAttributeService){
...
tabService.selectedEntity.restrictionFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<tabService.selectedEntity.restrictionFieldList.length; i++)

{

if (tabService.selectedEntity.restrictionFieldList[i].restrictionFieldId==restrictionFieldService.selectedEntity.restrictionFieldId)

tabService.selectedEntity.restrictionFieldList.splice(i,1);
...
restrictionFieldService.setSelectedEntity(null);
tabService.initRestrictionFieldList().then(function(response) {
tabService.childrenList.restrictionFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
restrictionFieldService.selectedEntity.projectList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.projectList.length; i++)

{

if (restrictionFieldService.selectedEntity.projectList[i].projectId==projectService.selectedEntity.projectId)

restrictionFieldService.selectedEntity.projectList.splice(i,1);

}

restrictionFieldService.selectedEntity.projectList.push(projectService.selectedEntity);
...
roleService.selectedEntity.show=false;
roleService.selectedEntity.annotationList.push(annotationService.selectedEntity);
roleService.insert().then(function successCallBack(response) { 
annotationService.selectedEntity.roleList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<annotationService.selectedEntity.roleList.length; i++)

{

if (annotationService.selectedEntity.roleList[i].roleId==roleService.selectedEntity.roleId)

annotationService.selectedEntity.roleList.splice(i,1);

}

annotationService.selectedEntity.roleList.push(roleService.selectedEntity);
...
roleService.setSelectedEntity(null);
annotationService.initRoleList().then(function(response) {
annotationService.childrenList.roleList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

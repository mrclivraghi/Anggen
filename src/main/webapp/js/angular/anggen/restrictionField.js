var restrictionFieldApp=angular.module("restrictionFieldApp",['ngFileUpload','ngTouch', 'ui.grid', 'ui.grid.pagination','ui.grid.selection','ui.date', 'ui.grid.exporter'])
...
.run(function($rootScope,securityService,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService){
...
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;}
$scope.addNew= function()
{
restrictionFieldService.setSelectedEntity(null);
restrictionFieldService.setEntityList(null);
restrictionFieldService.selectedEntity.show=true;
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#restrictionFieldTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.restrictionFieldDetailForm.$valid) return; 
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionFieldService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
,data: restrictionFieldService.entityList
 };
...
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("projectController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
projectService.selectedEntity.show=false;
projectService.selectedEntity.restrictionFieldList.push(restrictionFieldService.selectedEntity);
projectService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.project=response.data;
restrictionFieldService.initProjectList().then(function(response) {
restrictionFieldService.childrenList.projectList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
restrictionFieldService.selectedEntity.project=projectService.selectedEntity;
...
{
projectService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.project=null;
projectService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("relationshipController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
relationshipService.selectedEntity.show=false;
relationshipService.selectedEntity.restrictionField={};
relationshipService.selectedEntity.restrictionField.restrictionFieldId=restrictionFieldService.selectedEntity.restrictionFieldId;
relationshipService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.relationshipList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.relationshipList.length; i++)

{

if (restrictionFieldService.selectedEntity.relationshipList[i].relationshipId==relationshipService.selectedEntity.relationshipId)

restrictionFieldService.selectedEntity.relationshipList.splice(i,1);

}

restrictionFieldService.selectedEntity.relationshipList.push(relationshipService.selectedEntity);
...
relationshipService.setSelectedEntity(null);
restrictionFieldService.initRelationshipList().then(function(response) {
restrictionFieldService.childrenList.relationshipList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("restrictionEntityController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
restrictionEntityService.selectedEntity.show=false;
restrictionEntityService.selectedEntity.restrictionField={};
restrictionEntityService.selectedEntity.restrictionField.restrictionFieldId=restrictionFieldService.selectedEntity.restrictionFieldId;
restrictionEntityService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.restrictionEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.restrictionEntityList.length; i++)

{

if (restrictionFieldService.selectedEntity.restrictionEntityList[i].restrictionEntityId==restrictionEntityService.selectedEntity.restrictionEntityId)

restrictionFieldService.selectedEntity.restrictionEntityList.splice(i,1);
...
restrictionEntityService.setSelectedEntity(null);
restrictionFieldService.initRestrictionEntityList().then(function(response) {
restrictionFieldService.childrenList.restrictionEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("enumFieldController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
enumFieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.restrictionField={};
enumFieldService.selectedEntity.restrictionField.restrictionFieldId=restrictionFieldService.selectedEntity.restrictionFieldId;
enumFieldService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.enumFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.enumFieldList.length; i++)

{

if (restrictionFieldService.selectedEntity.enumFieldList[i].enumFieldId==enumFieldService.selectedEntity.enumFieldId)

restrictionFieldService.selectedEntity.enumFieldList.splice(i,1);

}

restrictionFieldService.selectedEntity.enumFieldList.push(enumFieldService.selectedEntity);
...
restrictionFieldService.childrenList.enumFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("enumValueController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.restrictionField={};
enumValueService.selectedEntity.restrictionField.restrictionFieldId=restrictionFieldService.selectedEntity.restrictionFieldId;
enumValueService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.enumValueList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.enumValueList.length; i++)

{

if (restrictionFieldService.selectedEntity.enumValueList[i].enumValueId==enumValueService.selectedEntity.enumValueId)

restrictionFieldService.selectedEntity.enumValueList.splice(i,1);

}

restrictionFieldService.selectedEntity.enumValueList.push(enumValueService.selectedEntity);
...
enumValueService.setSelectedEntity(null);
restrictionFieldService.initEnumValueList().then(function(response) {
restrictionFieldService.childrenList.enumValueList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("annotationController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.restrictionField={};
annotationService.selectedEntity.restrictionField.restrictionFieldId=restrictionFieldService.selectedEntity.restrictionFieldId;
annotationService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.annotationList.length; i++)

{

if (restrictionFieldService.selectedEntity.annotationList[i].annotationId==annotationService.selectedEntity.annotationId)

restrictionFieldService.selectedEntity.annotationList.splice(i,1);

}

restrictionFieldService.selectedEntity.annotationList.push(annotationService.selectedEntity);
...
annotationService.setSelectedEntity(null);
restrictionFieldService.initAnnotationList().then(function(response) {
restrictionFieldService.childrenList.annotationList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("restrictionEntityGroupController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
restrictionEntityGroupService.selectedEntity.show=false;
restrictionEntityGroupService.selectedEntity.restrictionField={};
restrictionEntityGroupService.selectedEntity.restrictionField.restrictionFieldId=restrictionFieldService.selectedEntity.restrictionFieldId;
restrictionEntityGroupService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.restrictionEntityGroupList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.restrictionEntityGroupList.length; i++)

{

if (restrictionFieldService.selectedEntity.restrictionEntityGroupList[i].restrictionEntityGroupId==restrictionEntityGroupService.selectedEntity.restrictionEntityGroupId)

restrictionFieldService.selectedEntity.restrictionEntityGroupList.splice(i,1);
...
restrictionEntityGroupService.setSelectedEntity(null);
restrictionFieldService.initRestrictionEntityGroupList().then(function(response) {
restrictionFieldService.childrenList.restrictionEntityGroupList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("userController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
restrictionFieldService.selectedEntity.userList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.userList.length; i++)

{

if (restrictionFieldService.selectedEntity.userList[i].userId==userService.selectedEntity.userId)

restrictionFieldService.selectedEntity.userList.splice(i,1);
...
userService.setSelectedEntity(null);
restrictionFieldService.initUserList().then(function(response) {
restrictionFieldService.childrenList.userList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("entityGroupController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
entityGroupService.selectedEntity.show=false;
entityGroupService.selectedEntity.restrictionFieldList.push(restrictionFieldService.selectedEntity);
entityGroupService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.entityGroup=response.data;
restrictionFieldService.initEntityGroupList().then(function(response) {
restrictionFieldService.childrenList.entityGroupList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
restrictionFieldService.selectedEntity.entityGroup=entityGroupService.selectedEntity;
...
{
entityGroupService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.entityGroup=null;
entityGroupService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("tabController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
tabService.selectedEntity.show=false;
tabService.selectedEntity.restrictionField={};
tabService.selectedEntity.restrictionField.restrictionFieldId=restrictionFieldService.selectedEntity.restrictionFieldId;
tabService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.tabList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.tabList.length; i++)

{

if (restrictionFieldService.selectedEntity.tabList[i].tabId==tabService.selectedEntity.tabId)

restrictionFieldService.selectedEntity.tabList.splice(i,1);

}

restrictionFieldService.selectedEntity.tabList.push(tabService.selectedEntity);
...
tabService.setSelectedEntity(null);
restrictionFieldService.initTabList().then(function(response) {
restrictionFieldService.childrenList.tabList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("enumEntityController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
enumEntityService.selectedEntity.show=false;
enumEntityService.selectedEntity.restrictionFieldList.push(restrictionFieldService.selectedEntity);
enumEntityService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.enumEntity=response.data;
restrictionFieldService.initEnumEntityList().then(function(response) {
restrictionFieldService.childrenList.enumEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
restrictionFieldService.selectedEntity.enumEntity=enumEntityService.selectedEntity;
...
{
enumEntityService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.enumEntity=null;
enumEntityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("fieldController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
fieldService.selectedEntity.show=false;
fieldService.selectedEntity.restrictionField={};
fieldService.selectedEntity.restrictionField.restrictionFieldId=restrictionFieldService.selectedEntity.restrictionFieldId;
fieldService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.fieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.fieldList.length; i++)

{

if (restrictionFieldService.selectedEntity.fieldList[i].fieldId==fieldService.selectedEntity.fieldId)

restrictionFieldService.selectedEntity.fieldList.splice(i,1);

}

restrictionFieldService.selectedEntity.fieldList.push(fieldService.selectedEntity);
...
annotationAttributeService.selectedEntity.show=false;
annotationAttributeService.selectedEntity.restrictionField={};
annotationAttributeService.selectedEntity.restrictionField.restrictionFieldId=restrictionFieldService.selectedEntity.restrictionFieldId;
annotationAttributeService.insert().then(function successCallBack(response) { 
restrictionFieldService.selectedEntity.annotationAttributeList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.annotationAttributeList.length; i++)

{

if (restrictionFieldService.selectedEntity.annotationAttributeList[i].annotationAttributeId==annotationAttributeService.selectedEntity.annotationAttributeId)

restrictionFieldService.selectedEntity.annotationAttributeList.splice(i,1);

}

restrictionFieldService.selectedEntity.annotationAttributeList.push(annotationAttributeService.selectedEntity);
...
annotationAttributeService.setSelectedEntity(null);
restrictionFieldService.initAnnotationAttributeList().then(function(response) {
restrictionFieldService.childrenList.annotationAttributeList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
this.entityList =		[];
this.selectedEntity= 	{show: false 
,restrictionEntityList: [],relationshipList: [],tabList: [],fieldList: [],enumFieldList: []};
this.childrenList=[]; 
this.addEntity=function (entity)
{
this.entityList.push(entity);
...
.controller("entityController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
restrictionFieldService.selectedEntity.entity=response.data;
...
restrictionFieldService.selectedEntity.entity=entityService.selectedEntity;
...
{
entityService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.entity=null;
entityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("roleController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//restrictionField
...
restrictionFieldService.selectedEntity.role=response.data;
...
restrictionFieldService.selectedEntity.role=roleService.selectedEntity;
...
{
roleService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.role=null;
roleService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()

...
/** @ngInject */
function ProjectController($scope,$http,$rootScope,$log,UtilityService ,projectService, SecurityService, MainService ,entityGroupService,enumEntityService,generationRunService)
{
var vm=this;
vm.activeTab=1;

...
{
if (!$scope.projectDetailForm.$valid) return; 
enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;projectService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
enumFieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.projectList.push(projectService.selectedEntity);
enumFieldService.insert().then(function successCallBack(response) { 
projectService.selectedEntity.enumFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<projectService.selectedEntity.enumFieldList.length; i++)

{

if (projectService.selectedEntity.enumFieldList[i].enumFieldId==enumFieldService.selectedEntity.enumFieldId)

projectService.selectedEntity.enumFieldList.splice(i,1);
...
enumFieldService.setSelectedEntity(null);
projectService.initEnumFieldList().then(function(response) {
projectService.childrenList.enumFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

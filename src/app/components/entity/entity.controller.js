...
/** @ngInject */
function EntityController($scope,$http ,entityService, SecurityService, MainService ,tabService,fieldService,annotationService,annotationAttributeService,enumFieldService,enumEntityService,projectService,entityGroupService,relationshipService,enumValueService,restrictionFieldService,roleService)
{

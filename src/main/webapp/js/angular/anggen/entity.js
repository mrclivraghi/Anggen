...
fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;}
$scope.addNew= function()
{
entityService.setSelectedEntity(null);
entityService.setEntityList(null);
entityService.selectedEntity.show=true;
fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;$('#entityTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.entityDetailForm.$valid) return; 
fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;tabService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;if (row.isSelected)
{
...
enumService.selectedEntity.show=false;
enumService.selectedEntity.entityList.push(entityService.selectedEntity);
...
restrictionService.selectedEntity.show=false;
restrictionService.selectedEntity.entityList.push(entityService.selectedEntity);
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.entityList.push(entityService.selectedEntity);
entityService.insert().then(function successCallBack(response) { 
...
.controller("projectController",function($scope,$http,projectService, securityService ,entityGroupService,entityService,restrictionEntityGroupService)
{
//entity
...
entityService.searchOne(projectService.selectedEntity.entityGroup).then(
function successCallback(response) {
if (securityService.restrictionList.entity==undefined || securityService.restrictionList.entity.canSearch)
entityGroupService.initEntityList().then(function successCallback(response) {
entityGroupService.childrenList.entityList=response.data;

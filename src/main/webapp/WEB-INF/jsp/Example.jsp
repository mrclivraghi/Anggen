...
<script type="text/javascript" src="../js/angular/example.js"></script>
			...
			<div class="panel panel-default default-panel">
				...
				<div class="panel-body">
					...
					<div class="pull-left right-input" style="height: 59px;">
						<div class="input-group">
							<span class="input-group-addon">example_place</span><select
								class="form-control " aria-describedby="sizing-addon3"
								ng-model="searchBean.example_place.example_placeId"
								id="example_place"
								ng-options="example_place.example_placeId as [] for example_place in childrenList.example_placeList"
				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="example-Default">
							...
							<div id="example-example_place" class="modal fade" role="dialog">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="input-group">
												<span class="input-group-addon">example_place</span><select
													class="form-control " aria-describedby="sizing-addon3"
													ng-model="selectedEntity.example_place" id="example_place"
													name="example_place"
													ng-options="example_place as [] for example_place in childrenList.example_placeList track by example_place.example_placeId"
													enctype="UTF-8"></select><span class="input-group-btn"><button
														ng-click="saveLinkedExample_place()"
														class="btn btn-default " id="example_place">Save</button></span>
											</div>
										</div>
							...
							<div class="pull-left" style="width: 100%">
								<div class="panel panel-default default-panel">
									<div class="panel-heading">
										example_place
										<button ng-click="showExample_placeDetail()"
											class="btn btn-default  pull-right" style="margin-top: -7px">Add
											new example_place</button>
										<button type="button" class="btn btn-default pull-right"
											style="margin-top: -7px" data-toggle="modal"
											data-target="#example-example_place">Link existing</button>
										<button ng-click="downloadExample_placeList()"
											class="btn btn-default pull-right" style="margin-top: -7px">
									...
									<div class="panel-body"
										ng-class="{&#39;has-error&#39;: !exampleDetailForm.example_place.$valid, &#39;has-success&#39;: exampleDetailForm.example_place.$valid}">
										<label id="example_place">example_place</label>
										<div id="example_place"
											ng-if="selectedEntity.example_placeList.length&gt;0">
											<div style="top: 100px"
												ui-grid="example_placeListGridOptions" ui-grid-pagination=""
	...
	<div ng-controller="placeController"
		...
		<form id="placeDetailForm" name="placeDetailForm"
			...
			<div class="panel panel-default default-panel">
				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="place-Default">
							...
							<div class="pull-left right-input"
								ng-class="{&#39;has-error&#39;: !placeDetailForm.placePlaceName.$valid, &#39;has-success&#39;: placeDetailForm.placePlaceName.$valid}"
								style="height: 59px">
								<div class="input-group">
									<span class="input-group-addon">placePlaceName</span><input
										class="form-control " aria-describedby="sizing-addon3"
										type="text" id="place-placePlaceName"
										ng-model="selectedEntity.placePlaceName" ng-readonly="false"
										name="placePlaceName" placeholder="placePlaceName" />
								</div>
							</div>
						</div>
				...
				<script type="text/javascript">$('#placeTabs a:first').tab('show');</script>
				<div class="panel-body">
					<div class="pull-left">
						<form id="placeActionButton" ng-if="selectedEntity.show">
							...
							<button ng-click="remove()" class="btn btn-default "
								ng-if="selectedEntity.placeId&gt;0">Remove</button>
						</form>
					</div>
				</div>
			</div>

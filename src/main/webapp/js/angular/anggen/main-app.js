angular.module("anggenApp",['ngRoute','ui.bootstrap','ngFileUpload','ngTouch', 'ui.grid', 'ui.grid.pagination','ui.grid.selection','ui.date', 'ui.grid.exporter']);
angular.module("anggenApp").service("securityService",function($http)
		{

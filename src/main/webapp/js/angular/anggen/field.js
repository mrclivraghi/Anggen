...
.run(function($rootScope,securityService,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService){
...
.controller("fieldController",function($scope,$http,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService)
{
//null
...
tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;}
$scope.addNew= function()
{
fieldService.setSelectedEntity(null);
fieldService.setEntityList(null);
fieldService.selectedEntity.show=true;
tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;$('#fieldTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.fieldDetailForm.$valid) return; 
tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;fieldService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("enumFieldController",function($scope,$http,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService)
{
//field
...
fieldService.selectedEntity.enumField=response.data;
...
fieldService.selectedEntity.enumField=enumFieldService.selectedEntity;
...
{
enumFieldService.selectedEntity.show=false;
fieldService.selectedEntity.enumField=null;
enumFieldService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("tabController",function($scope,$http,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService)
{
//field
...
.controller("annotationAttributeController",function($scope,$http,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService)
{
//field
...
.controller("relationshipController",function($scope,$http,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService)
{
//field
...
.controller("entityController",function($scope,$http,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService)
{
//field
...
.controller("roleController",function($scope,$http,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService)
{
//field
...
roleService.selectedEntity.show=false;
roleService.selectedEntity.field={};
roleService.selectedEntity.field.fieldId=fieldService.selectedEntity.fieldId;
...
.controller("entityGroupController",function($scope,$http,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService)
{
//field
...
entityGroupService.selectedEntity.show=false;
entityGroupService.selectedEntity.field={};
entityGroupService.selectedEntity.field.fieldId=fieldService.selectedEntity.fieldId;
...
relationshipService.insert().then(function successCallBack(response) { 
fieldService.selectedEntity.relationship=response.data;
fieldService.initRelationshipList().then(function(response) {
fieldService.childrenList.relationshipList=response.data;
});
},function errorCallback(response) { 
...
fieldService.selectedEntity.relationship=relationshipService.selectedEntity;
...
{
relationshipService.selectedEntity.show=false;
fieldService.selectedEntity.relationship=null;
relationshipService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("annotationController",function($scope,$http,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService)
{
//field
...
.controller("restrictionEntityController",function($scope,$http,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService)
{
//field
...
.controller("restrictionFieldController",function($scope,$http,fieldService, securityService ,tabService,enumFieldService,relationshipService,entityService,restrictionFieldService,roleService,annotationService,annotationAttributeService)
{
//field

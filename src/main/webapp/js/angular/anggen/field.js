...
.controller("fieldController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//null
...
tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;userService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;}
$scope.addNew= function()
{
fieldService.setSelectedEntity(null);
fieldService.setEntityList(null);
fieldService.selectedEntity.show=true;
tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;userService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;$('#fieldTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.fieldDetailForm.$valid) return; 
tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;userService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;fieldService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;userService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("tabController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
.controller("enumEntityController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
enumEntityService.selectedEntity.show=false;
enumEntityService.selectedEntity.fieldList.push(fieldService.selectedEntity);
enumEntityService.insert().then(function successCallBack(response) { 
fieldService.selectedEntity.enumEntity=response.data;
fieldService.initEnumEntityList().then(function(response) {
fieldService.childrenList.enumEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
fieldService.selectedEntity.enumEntity=enumEntityService.selectedEntity;
...
{
enumEntityService.selectedEntity.show=false;
fieldService.selectedEntity.enumEntity=null;
enumEntityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("projectController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
fieldService.selectedEntity.project=response.data;
...
fieldService.selectedEntity.project=projectService.selectedEntity;
...
{
projectService.selectedEntity.show=false;
fieldService.selectedEntity.project=null;
projectService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("roleController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
fieldService.selectedEntity.role=response.data;
...
fieldService.selectedEntity.role=roleService.selectedEntity;
...
{
roleService.selectedEntity.show=false;
fieldService.selectedEntity.role=null;
roleService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("relationshipController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
relationshipService.selectedEntity.show=false;
relationshipService.selectedEntity.field={};
relationshipService.selectedEntity.field.fieldId=fieldService.selectedEntity.fieldId;
relationshipService.insert().then(function successCallBack(response) { 
fieldService.selectedEntity.relationshipList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<fieldService.selectedEntity.relationshipList.length; i++)

{

if (fieldService.selectedEntity.relationshipList[i].relationshipId==relationshipService.selectedEntity.relationshipId)

fieldService.selectedEntity.relationshipList.splice(i,1);
...
relationshipService.setSelectedEntity(null);
fieldService.initRelationshipList().then(function(response) {
fieldService.childrenList.relationshipList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("annotationController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
.controller("entityGroupController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
fieldService.selectedEntity.entityGroup=response.data;
...
fieldService.selectedEntity.entityGroup=entityGroupService.selectedEntity;
...
{
entityGroupService.selectedEntity.show=false;
fieldService.selectedEntity.entityGroup=null;
entityGroupService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("userController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
.controller("restrictionEntityGroupController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
restrictionEntityGroupService.selectedEntity.show=false;
restrictionEntityGroupService.selectedEntity.field={};
restrictionEntityGroupService.selectedEntity.field.fieldId=fieldService.selectedEntity.fieldId;
...
.controller("restrictionFieldController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
.controller("restrictionEntityController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
restrictionEntityService.selectedEntity.show=false;
restrictionEntityService.selectedEntity.field={};
restrictionEntityService.selectedEntity.field.fieldId=fieldService.selectedEntity.fieldId;
...
.controller("enumFieldController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
enumFieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.field={};
enumFieldService.selectedEntity.field.fieldId=fieldService.selectedEntity.fieldId;
...
.controller("annotationAttributeController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
annotationAttributeService.selectedEntity.show=false;
annotationAttributeService.selectedEntity.field={};
annotationAttributeService.selectedEntity.field.fieldId=fieldService.selectedEntity.fieldId;
annotationAttributeService.insert().then(function successCallBack(response) { 
fieldService.selectedEntity.annotationAttributeList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<fieldService.selectedEntity.annotationAttributeList.length; i++)

{

if (fieldService.selectedEntity.annotationAttributeList[i].annotationAttributeId==annotationAttributeService.selectedEntity.annotationAttributeId)

fieldService.selectedEntity.annotationAttributeList.splice(i,1);
...
annotationAttributeService.setSelectedEntity(null);
fieldService.initAnnotationAttributeList().then(function(response) {
fieldService.childrenList.annotationAttributeList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("enumValueController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.field={};
enumValueService.selectedEntity.field.fieldId=fieldService.selectedEntity.fieldId;
enumValueService.insert().then(function successCallBack(response) { 
fieldService.selectedEntity.enumValueList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<fieldService.selectedEntity.enumValueList.length; i++)

{

if (fieldService.selectedEntity.enumValueList[i].enumValueId==enumValueService.selectedEntity.enumValueId)

fieldService.selectedEntity.enumValueList.splice(i,1);
...
enumValueService.setSelectedEntity(null);
fieldService.initEnumValueList().then(function(response) {
fieldService.childrenList.enumValueList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("entityController",function($scope,$http,fieldService, securityService ,tabService,relationshipService,entityService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,userService,enumFieldService,annotationService,annotationAttributeService)
{
//field

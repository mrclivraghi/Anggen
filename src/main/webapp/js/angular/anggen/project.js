...
projectService.selectedEntity.restrictionFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<projectService.selectedEntity.restrictionFieldList.length; i++)

{

if (projectService.selectedEntity.restrictionFieldList[i].restrictionFieldId==restrictionFieldService.selectedEntity.restrictionFieldId)

projectService.selectedEntity.restrictionFieldList.splice(i,1);
...
restrictionFieldService.setSelectedEntity(null);
projectService.initRestrictionFieldList().then(function(response) {
projectService.childrenList.restrictionFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

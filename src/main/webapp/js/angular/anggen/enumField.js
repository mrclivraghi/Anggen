var enumFieldApp=angular.module("enumFieldApp",['ngTouch', 'ui.grid', 'ui.grid.pagination','ui.grid.selection','ui.date', 'ui.grid.exporter'])
...
{
if (!$scope.enumFieldDetailForm.$valid) return; 
tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;enumFieldService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;if (row.isSelected)
{
...
enumFieldService.selectedEntity.roleList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumFieldService.selectedEntity.roleList.length; i++)

{

if (enumFieldService.selectedEntity.roleList[i].roleId==roleService.selectedEntity.roleId)

enumFieldService.selectedEntity.roleList.splice(i,1);
...
enumFieldService.selectedEntity.projectList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<enumFieldService.selectedEntity.projectList.length; i++)

{

if (enumFieldService.selectedEntity.projectList[i].projectId==projectService.selectedEntity.projectId)

enumFieldService.selectedEntity.projectList.splice(i,1);

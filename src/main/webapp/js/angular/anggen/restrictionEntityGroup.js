...
.run(function($rootScope,securityService,restrictionEntityGroupService, securityService ,roleService,restrictionFieldService,restrictionEntityService,userService,entityGroupService,projectService,entityService){
...
.controller("restrictionEntityGroupController",function($scope,$http,restrictionEntityGroupService, securityService ,roleService,restrictionFieldService,restrictionEntityService,userService,entityGroupService,projectService,entityService)
{
//null
...
roleService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityService.selectedEntity.show=false;}
$scope.addNew= function()
{
restrictionEntityGroupService.setSelectedEntity(null);
restrictionEntityGroupService.setEntityList(null);
restrictionEntityGroupService.selectedEntity.show=true;
roleService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityService.selectedEntity.show=false;$('#restrictionEntityGroupTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.restrictionEntityGroupDetailForm.$valid) return; 
roleService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityGroupService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
roleService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("entityGroupController",function($scope,$http,restrictionEntityGroupService, securityService ,roleService,restrictionFieldService,restrictionEntityService,userService,entityGroupService,projectService,entityService)
{
...
entityGroupService.selectedEntity.show=false;
entityGroupService.selectedEntity.restrictionEntityGroup={};
entityGroupService.selectedEntity.restrictionEntityGroup.restrictionEntityGroupId=restrictionEntityGroupService.selectedEntity.restrictionEntityGroupId;
...
.controller("restrictionFieldController",function($scope,$http,restrictionEntityGroupService, securityService ,roleService,restrictionFieldService,restrictionEntityService,userService,entityGroupService,projectService,entityService)
{
//restrictionEntityGroup
...
.controller("userController",function($scope,$http,restrictionEntityGroupService, securityService ,roleService,restrictionFieldService,restrictionEntityService,userService,entityGroupService,projectService,entityService)
{
//restrictionEntityGroup
...
.controller("restrictionEntityController",function($scope,$http,restrictionEntityGroupService, securityService ,roleService,restrictionFieldService,restrictionEntityService,userService,entityGroupService,projectService,entityService)
{
//restrictionEntityGroup
...
.controller("projectController",function($scope,$http,restrictionEntityGroupService, securityService ,roleService,restrictionFieldService,restrictionEntityService,userService,entityGroupService,projectService,entityService)
{
//restrictionEntityGroup
...
projectService.selectedEntity.show=false;
projectService.selectedEntity.restrictionEntityGroup={};
projectService.selectedEntity.restrictionEntityGroup.restrictionEntityGroupId=restrictionEntityGroupService.selectedEntity.restrictionEntityGroupId;
...
.controller("roleController",function($scope,$http,restrictionEntityGroupService, securityService ,roleService,restrictionFieldService,restrictionEntityService,userService,entityGroupService,projectService,entityService)
{
//restrictionEntityGroup
...
roleService.selectedEntity.show=false;
roleService.selectedEntity.restrictionEntityGroup={};
roleService.selectedEntity.restrictionEntityGroup.restrictionEntityGroupId=restrictionEntityGroupService.selectedEntity.restrictionEntityGroupId;
...
.controller("entityController",function($scope,$http,restrictionEntityGroupService, securityService ,roleService,restrictionFieldService,restrictionEntityService,userService,entityGroupService,projectService,entityService)
{
//restrictionEntityGroup

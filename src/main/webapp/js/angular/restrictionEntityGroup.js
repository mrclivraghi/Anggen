...
entityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;userService.selectedEntity.show=false;}
$scope.addNew= function()
{
restrictionEntityGroupService.setSelectedEntity(null);
restrictionEntityGroupService.setEntityList(null);
restrictionEntityGroupService.selectedEntity.show=true;
entityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#restrictionEntityGroupTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.restrictionEntityGroupDetailForm.$valid) return; 
entityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionEntityGroupService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
entityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;userService.selectedEntity.show=false;if (row.isSelected)
{

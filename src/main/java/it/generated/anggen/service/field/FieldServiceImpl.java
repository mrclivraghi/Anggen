    ...
    implements FieldService
{
    ...
    public List<it.generated.anggen.model.field.Field> find(FieldSearchBean field) {
        return fieldRepository.findByNameAndFieldIdAndTabAndRestrictionFieldAndAnnotationAndEntityAndFieldType(field.getName(),field.getFieldId(),field.getTab(),field.getRestrictionFieldList()==null? null :field.getRestrictionFieldList().get(0),field.getAnnotationList()==null? null :field.getAnnotationList().get(0),field.getEntity(), (field.getFieldType()==null)? null : field.getFieldType().getValue());
    }

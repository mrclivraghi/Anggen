...
.run(function($rootScope,securityService,roleService, securityService ,restrictionEntityService,entityService,entityGroupService,projectService,restrictionEntityGroupService,tabService,enumFieldService,enumValueService,annotationService,annotationAttributeService,fieldService,restrictionFieldService,relationshipService,userService){
...
.controller("roleController",function($scope,$http,roleService, securityService ,restrictionEntityService,entityService,entityGroupService,projectService,restrictionEntityGroupService,tabService,enumFieldService,enumValueService,annotationService,annotationAttributeService,fieldService,restrictionFieldService,relationshipService,userService)
{
//null
...
restrictionEntityService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;userService.selectedEntity.show=false;}
$scope.addNew= function()
{
roleService.setSelectedEntity(null);
roleService.setEntityList(null);
roleService.selectedEntity.show=true;
restrictionEntityService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#roleTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.roleDetailForm.$valid) return; 
restrictionEntityService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;userService.selectedEntity.show=false;roleService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
restrictionEntityService.selectedEntity.show=false;entityService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;userService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("restrictionEntityGroupController",function($scope,$http,restrictionEntityGroupService, securityService ,entityGroupService,projectService,entityService,tabService,enumFieldService,enumValueService,annotationService,annotationAttributeService,fieldService,restrictionFieldService,roleService,restrictionEntityService,userService,relationshipService)
{
//role
...
.controller("tabController",function($scope,$http,tabService, securityService ,entityService,entityGroupService,projectService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,fieldService,annotationService,annotationAttributeService,enumFieldService,enumValueService,relationshipService,userService)
{
...
this.entityList =		[];
this.selectedEntity= 	{show: false 
,tabList: [],enumFieldList: [],fieldList: [],relationshipList: [],restrictionEntityList: []};
this.childrenList=[]; 
this.addEntity=function (entity)
{
this.entityList.push(entity);
...
.controller("entityController",function($scope,$http,entityService, securityService ,entityGroupService,projectService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,fieldService,tabService,enumFieldService,enumValueService,annotationService,annotationAttributeService,relationshipService,userService)
{
//tab
...
tabService.selectedEntity.entityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<tabService.selectedEntity.entityList.length; i++)

{

if (tabService.selectedEntity.entityList[i].entityId==entityService.selectedEntity.entityId)

tabService.selectedEntity.entityList.splice(i,1);
...
entityService.selectedEntity.restrictionFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityService.selectedEntity.restrictionFieldList.length; i++)

{

if (entityService.selectedEntity.restrictionFieldList[i].restrictionFieldId==restrictionFieldService.selectedEntity.restrictionFieldId)

entityService.selectedEntity.restrictionFieldList.splice(i,1);
...
restrictionFieldService.setSelectedEntity(null);
entityService.initRestrictionFieldList().then(function(response) {
entityService.childrenList.restrictionFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("entityGroupController",function($scope,$http,entityGroupService, securityService ,projectService,entityService,tabService,enumFieldService,enumValueService,annotationService,annotationAttributeService,fieldService,restrictionFieldService,roleService,restrictionEntityService,userService,restrictionEntityGroupService,relationshipService)
{
//restrictionField
...
restrictionFieldService.selectedEntity.entityGroupList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionFieldService.selectedEntity.entityGroupList.length; i++)

{

if (restrictionFieldService.selectedEntity.entityGroupList[i].entityGroupId==entityGroupService.selectedEntity.entityGroupId)

restrictionFieldService.selectedEntity.entityGroupList.splice(i,1);
...
relationshipService.selectedEntity.userList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<relationshipService.selectedEntity.userList.length; i++)

{

if (relationshipService.selectedEntity.userList[i].userId==userService.selectedEntity.userId)

relationshipService.selectedEntity.userList.splice(i,1);
...
userService.setSelectedEntity(null);
relationshipService.initUserList().then(function(response) {
relationshipService.childrenList.userList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
userService.selectedEntity.projectList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<userService.selectedEntity.projectList.length; i++)

{

if (userService.selectedEntity.projectList[i].projectId==projectService.selectedEntity.projectId)

userService.selectedEntity.projectList.splice(i,1);
...
projectService.setSelectedEntity(null);
userService.initProjectList().then(function(response) {
userService.childrenList.projectList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("annotationController",function($scope,$http,annotationService, securityService ,annotationAttributeService,enumFieldService,entityService,entityGroupService,projectService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,fieldService,tabService,relationshipService,userService,enumValueService)
{
//project
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.projectList.push(projectService.selectedEntity);
annotationService.insert().then(function successCallBack(response) { 
projectService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<projectService.selectedEntity.annotationList.length; i++)

{

if (projectService.selectedEntity.annotationList[i].annotationId==annotationService.selectedEntity.annotationId)

projectService.selectedEntity.annotationList.splice(i,1);

}

projectService.selectedEntity.annotationList.push(annotationService.selectedEntity);
...
annotationService.setSelectedEntity(null);
projectService.initAnnotationList().then(function(response) {
projectService.childrenList.annotationList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
if (annotationService.selectedEntity.fieldList[i].fieldId==fieldService.selectedEntity.fieldId)

annotationService.selectedEntity.fieldList.splice(i,1);

}

annotationService.selectedEntity.fieldList.push(fieldService.selectedEntity);
...
fieldService.selectedEntity.restrictionEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<fieldService.selectedEntity.restrictionEntityList.length; i++)

{

if (fieldService.selectedEntity.restrictionEntityList[i].restrictionEntityId==restrictionEntityService.selectedEntity.restrictionEntityId)

fieldService.selectedEntity.restrictionEntityList.splice(i,1);
...
restrictionEntityService.setSelectedEntity(null);
fieldService.initRestrictionEntityList().then(function(response) {
fieldService.childrenList.restrictionEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("annotationAttributeController",function($scope,$http,annotationAttributeService, securityService ,annotationService,enumFieldService,entityService,entityGroupService,projectService,restrictionEntityGroupService,roleService,restrictionEntityService,restrictionFieldService,fieldService,tabService,relationshipService,userService,enumValueService)
{
//enumValue

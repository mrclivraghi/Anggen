...
{
if (!$scope.restrictionEntityGroupDetailForm.$valid) return; 
entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionEntityGroupService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.restrictionEntityGroup={};
entityService.selectedEntity.restrictionEntityGroup.restrictionEntityGroupId=restrictionEntityGroupService.selectedEntity.restrictionEntityGroupId;
...
fieldService.selectedEntity.show=false;
fieldService.selectedEntity.restrictionEntityGroup={};
fieldService.selectedEntity.restrictionEntityGroup.restrictionEntityGroupId=restrictionEntityGroupService.selectedEntity.restrictionEntityGroupId;
...
restrictionEntityGroupService.selectedEntity.tab=response.data;
...
restrictionEntityGroupService.selectedEntity.tab=tabService.selectedEntity;
...
{
tabService.selectedEntity.show=false;
restrictionEntityGroupService.selectedEntity.tab=null;
tabService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()

...
restrictionFieldService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.entityGroupList.push(entityGroupService.selectedEntity);
...
enumValueService.selectedEntity.roleList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.roleList.length; i++)

{

if (enumValueService.selectedEntity.roleList[i].roleId==roleService.selectedEntity.roleId)

enumValueService.selectedEntity.roleList.splice(i,1);
...
roleService.setSelectedEntity(null);
enumValueService.initRoleList().then(function(response) {
enumValueService.childrenList.roleList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
userService.selectedEntity.show=false;
userService.selectedEntity.fieldList.push(fieldService.selectedEntity);
userService.insert().then(function successCallBack(response) { 
fieldService.selectedEntity.userList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<fieldService.selectedEntity.userList.length; i++)

{

if (fieldService.selectedEntity.userList[i].userId==userService.selectedEntity.userId)

fieldService.selectedEntity.userList.splice(i,1);

}

fieldService.selectedEntity.userList.push(userService.selectedEntity);
...
userService.setSelectedEntity(null);
fieldService.initUserList().then(function(response) {
fieldService.childrenList.userList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

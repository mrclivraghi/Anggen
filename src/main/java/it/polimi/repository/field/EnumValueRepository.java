...
public interface EnumValueRepository
    extends CrudRepository<it.polimi.model.field.EnumValue, java.lang.Long>
{


    public List<it.polimi.model.field.EnumValue> findByEnumValueId(java.lang.Long enumValueId);

    public List<it.polimi.model.field.EnumValue> findByValue(java.lang.Integer value);

    public List<it.polimi.model.field.EnumValue> findByName(java.lang.String name);

    public List<it.polimi.model.field.EnumValue> findByEnumField(it.polimi.model.field.EnumField enumField);
    ...
    public List<it.polimi.model.field.EnumValue> findByEnumValueIdAndValueAndNameAndEnumField(

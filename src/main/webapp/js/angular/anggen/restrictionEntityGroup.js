...
relationshipService.selectedEntity.enumEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<relationshipService.selectedEntity.enumEntityList.length; i++)

{

if (relationshipService.selectedEntity.enumEntityList[i].enumEntityId==enumEntityService.selectedEntity.enumEntityId)

relationshipService.selectedEntity.enumEntityList.splice(i,1);
...
enumEntityService.setSelectedEntity(null);
relationshipService.initEnumEntityList().then(function(response) {
relationshipService.childrenList.enumEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

...
entityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;}
$scope.addNew= function()
{
entityGroupService.setSelectedEntity(null);
entityGroupService.setEntityList(null);
entityGroupService.selectedEntity.show=true;
entityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;$('#entityGroupTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.entityGroupDetailForm.$valid) return; 
entityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;entityGroupService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
entityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;fieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;annotationService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;if (row.isSelected)
{

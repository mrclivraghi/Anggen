    ...
    implements RoleService
{
    ...
    public List<it.anggen.model.security.Role> find(RoleSearchBean role) {
        return roleRepository.findByRoleIdAndRoleAndUserAndRestrictionEntityGroupAndRestrictionFieldAndRestrictionEntity(role.getRoleId(),role.getRole(),role.getUserList()==null? null :role.getUserList().get(0),role.getRestrictionEntityGroupList()==null? null :role.getRestrictionEntityGroupList().get(0),role.getRestrictionFieldList()==null? null :role.getRestrictionFieldList().get(0),role.getRestrictionEntityList()==null? null :role.getRestrictionEntityList().get(0));
    }

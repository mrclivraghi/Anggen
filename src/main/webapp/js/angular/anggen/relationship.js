...
.run(function($rootScope,securityService,relationshipService, securityService ,entityService,fieldService,entityGroupService,restrictionEntityService,tabService,enumFieldService,annotationService,annotationAttributeService){
...
.controller("relationshipController",function($scope,$http,relationshipService, securityService ,entityService,fieldService,entityGroupService,restrictionEntityService,tabService,enumFieldService,annotationService,annotationAttributeService)
{
//null
...
entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;}
$scope.addNew= function()
{
relationshipService.setSelectedEntity(null);
relationshipService.setEntityList(null);
relationshipService.selectedEntity.show=true;
entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;$('#relationshipTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.relationshipDetailForm.$valid) return; 
entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;relationshipService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("annotationController",function($scope,$http,relationshipService, securityService ,entityService,fieldService,entityGroupService,restrictionEntityService,tabService,enumFieldService,annotationService,annotationAttributeService)
{
//relationship
...
.controller("entityController",function($scope,$http,relationshipService, securityService ,entityService,fieldService,entityGroupService,restrictionEntityService,tabService,enumFieldService,annotationService,annotationAttributeService)
{
//relationship
...
.controller("enumFieldController",function($scope,$http,relationshipService, securityService ,entityService,fieldService,entityGroupService,restrictionEntityService,tabService,enumFieldService,annotationService,annotationAttributeService)
{
//relationship
...
relationshipService.selectedEntity.enumField=response.data;
...
relationshipService.selectedEntity.enumField=enumFieldService.selectedEntity;
...
{
enumFieldService.selectedEntity.show=false;
relationshipService.selectedEntity.enumField=null;
enumFieldService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("annotationAttributeController",function($scope,$http,relationshipService, securityService ,entityService,fieldService,entityGroupService,restrictionEntityService,tabService,enumFieldService,annotationService,annotationAttributeService)
{
//relationship
...
.controller("fieldController",function($scope,$http,relationshipService, securityService ,entityService,fieldService,entityGroupService,restrictionEntityService,tabService,enumFieldService,annotationService,annotationAttributeService)
{
//relationship
...
.controller("entityGroupController",function($scope,$http,relationshipService, securityService ,entityService,fieldService,entityGroupService,restrictionEntityService,tabService,enumFieldService,annotationService,annotationAttributeService)
{
//relationship
...
entityGroupService.selectedEntity.show=false;
entityGroupService.selectedEntity.relationship={};
entityGroupService.selectedEntity.relationship.relationshipId=relationshipService.selectedEntity.relationshipId;
...
.controller("tabController",function($scope,$http,relationshipService, securityService ,entityService,fieldService,entityGroupService,restrictionEntityService,tabService,enumFieldService,annotationService,annotationAttributeService)
{
//relationship
...
.controller("restrictionEntityController",function($scope,$http,relationshipService, securityService ,entityService,fieldService,entityGroupService,restrictionEntityService,tabService,enumFieldService,annotationService,annotationAttributeService)
{
//relationship
...
fieldService.insert().then(function successCallBack(response) { 
relationshipService.selectedEntity.field=response.data;
relationshipService.initFieldList().then(function(response) {
relationshipService.childrenList.fieldList=response.data;
});
},function errorCallback(response) { 
...
relationshipService.selectedEntity.field=fieldService.selectedEntity;
...
{
fieldService.selectedEntity.show=false;
relationshipService.selectedEntity.field=null;
fieldService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()

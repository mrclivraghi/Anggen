    ...
    extends CrudRepository<it.generated.anggen.model.field.AnnotationAttribute, java.lang.Long>
{
    ...
    @Query("select a from AnnotationAttribute a where  (:value is null or :value='' or cast(:value as string)=a.value) and (:property is null or :property='' or cast(:property as string)=a.property) and (:annotationAttributeId is null or cast(:annotationAttributeId as string)=cast(a.annotationAttributeId as string)) and (:annotation=a.annotation or :annotation is null) ")
    public List<it.generated.anggen.model.field.AnnotationAttribute> findByValueAndPropertyAndAnnotationAttributeIdAndAnnotation(

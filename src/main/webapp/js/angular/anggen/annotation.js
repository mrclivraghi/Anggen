var annotationApp=angular.module("annotationApp",['ngFileUpload','ngTouch', 'ui.grid', 'ui.grid.pagination','ui.grid.selection','ui.date', 'ui.grid.exporter'])
...
.run(function($rootScope,securityService,annotationService, securityService ,enumFieldService,tabService,relationshipService,entityService,fieldService,restrictionFieldService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityService,userService,annotationAttributeService){
...
.controller("annotationController",function($scope,$http,annotationService, securityService ,enumFieldService,tabService,relationshipService,entityService,fieldService,restrictionFieldService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityService,userService,annotationAttributeService)
{
//null
...
.controller("restrictionFieldController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,entityService,fieldService,tabService,enumFieldService,annotationService,relationshipService,annotationAttributeService,restrictionEntityService,userService)
{
//annotation
...
annotationService.selectedEntity.restrictionFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<annotationService.selectedEntity.restrictionFieldList.length; i++)

{

if (annotationService.selectedEntity.restrictionFieldList[i].restrictionFieldId==restrictionFieldService.selectedEntity.restrictionFieldId)

annotationService.selectedEntity.restrictionFieldList.splice(i,1);

}

annotationService.selectedEntity.restrictionFieldList.push(restrictionFieldService.selectedEntity);
...
restrictionFieldService.setSelectedEntity(null);
annotationService.initRestrictionFieldList().then(function(response) {
annotationService.childrenList.restrictionFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("tabController",function($scope,$http,tabService, securityService ,enumFieldService,annotationService,relationshipService,entityService,fieldService,restrictionFieldService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityService,userService,annotationAttributeService)
{
//restrictionField
...
tabService.selectedEntity.show=false;
tabService.selectedEntity.restrictionFieldList.push(restrictionFieldService.selectedEntity);
...
.controller("projectController",function($scope,$http,projectService, securityService ,enumEntityService,enumValueService,entityGroupService,restrictionEntityGroupService,roleService,restrictionFieldService,fieldService,tabService,enumFieldService,annotationService,relationshipService,entityService,restrictionEntityService,annotationAttributeService,userService)
{
//tab
...
projectService.selectedEntity.show=false;
projectService.selectedEntity.tabList.push(tabService.selectedEntity);
projectService.insert().then(function successCallBack(response) { 
tabService.selectedEntity.projectList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<tabService.selectedEntity.projectList.length; i++)

{

if (tabService.selectedEntity.projectList[i].projectId==projectService.selectedEntity.projectId)

tabService.selectedEntity.projectList.splice(i,1);

}

tabService.selectedEntity.projectList.push(projectService.selectedEntity);
...
projectService.setSelectedEntity(null);
tabService.initProjectList().then(function(response) {
tabService.childrenList.projectList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("restrictionEntityController",function($scope,$http,restrictionEntityService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,entityService,fieldService,tabService,enumFieldService,annotationService,relationshipService,annotationAttributeService,restrictionFieldService,userService)
{
//project
...
projectService.selectedEntity.restrictionEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<projectService.selectedEntity.restrictionEntityList.length; i++)

{

if (projectService.selectedEntity.restrictionEntityList[i].restrictionEntityId==restrictionEntityService.selectedEntity.restrictionEntityId)

projectService.selectedEntity.restrictionEntityList.splice(i,1);
...
restrictionEntityService.setSelectedEntity(null);
projectService.initRestrictionEntityList().then(function(response) {
projectService.childrenList.restrictionEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("roleController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,entityService,fieldService,tabService,enumFieldService,annotationService,relationshipService,annotationAttributeService,restrictionFieldService,restrictionEntityService,userService)
{
//restrictionEntity
...
.controller("enumValueController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,restrictionEntityGroupService,roleService,restrictionFieldService,fieldService,tabService,enumFieldService,annotationService,relationshipService,entityService,restrictionEntityService,annotationAttributeService,userService)
{
//role
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.roleList.push(roleService.selectedEntity);
enumValueService.insert().then(function successCallBack(response) { 
roleService.selectedEntity.enumValueList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<roleService.selectedEntity.enumValueList.length; i++)

{

if (roleService.selectedEntity.enumValueList[i].enumValueId==enumValueService.selectedEntity.enumValueId)

roleService.selectedEntity.enumValueList.splice(i,1);

}

roleService.selectedEntity.enumValueList.push(enumValueService.selectedEntity);
...
enumValueService.setSelectedEntity(null);
roleService.initEnumValueList().then(function(response) {
roleService.childrenList.enumValueList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.enumValueList.push(enumValueService.selectedEntity);
entityService.insert().then(function successCallBack(response) { 
enumValueService.selectedEntity.entityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.entityList.length; i++)

{

if (enumValueService.selectedEntity.entityList[i].entityId==entityService.selectedEntity.entityId)

enumValueService.selectedEntity.entityList.splice(i,1);

}

enumValueService.selectedEntity.entityList.push(entityService.selectedEntity);
...
entityService.setSelectedEntity(null);
enumValueService.initEntityList().then(function(response) {
enumValueService.childrenList.entityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("annotationAttributeController",function($scope,$http,annotationAttributeService, securityService ,annotationService,enumFieldService,tabService,relationshipService,entityService,fieldService,restrictionFieldService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityService,userService)
{
//entity
...
annotationAttributeService.selectedEntity.show=false;
annotationAttributeService.selectedEntity.entityList.push(entityService.selectedEntity);
annotationAttributeService.insert().then(function successCallBack(response) { 
entityService.selectedEntity.annotationAttributeList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityService.selectedEntity.annotationAttributeList.length; i++)

{

if (entityService.selectedEntity.annotationAttributeList[i].annotationAttributeId==annotationAttributeService.selectedEntity.annotationAttributeId)

entityService.selectedEntity.annotationAttributeList.splice(i,1);

}

entityService.selectedEntity.annotationAttributeList.push(annotationAttributeService.selectedEntity);
...
annotationAttributeService.setSelectedEntity(null);
entityService.initAnnotationAttributeList().then(function(response) {
entityService.childrenList.annotationAttributeList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
fieldService.selectedEntity.entityGroupList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<fieldService.selectedEntity.entityGroupList.length; i++)

{

if (fieldService.selectedEntity.entityGroupList[i].entityGroupId==entityGroupService.selectedEntity.entityGroupId)

fieldService.selectedEntity.entityGroupList.splice(i,1);

}

fieldService.selectedEntity.entityGroupList.push(entityGroupService.selectedEntity);
...
entityGroupService.setSelectedEntity(null);
fieldService.initEntityGroupList().then(function(response) {
fieldService.childrenList.entityGroupList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("userController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,entityService,fieldService,tabService,enumFieldService,annotationService,relationshipService,annotationAttributeService,restrictionFieldService,restrictionEntityService)
{
//entityGroup
...
.controller("enumFieldController",function($scope,$http,enumFieldService, securityService ,tabService,relationshipService,entityService,fieldService,restrictionFieldService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionEntityService,userService,annotationService,annotationAttributeService)
{
//user
...
enumFieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.userList.push(userService.selectedEntity);
enumFieldService.insert().then(function successCallBack(response) { 
userService.selectedEntity.enumFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<userService.selectedEntity.enumFieldList.length; i++)

{

if (userService.selectedEntity.enumFieldList[i].enumFieldId==enumFieldService.selectedEntity.enumFieldId)

userService.selectedEntity.enumFieldList.splice(i,1);

}

userService.selectedEntity.enumFieldList.push(enumFieldService.selectedEntity);
...
userService.childrenList.enumFieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("relationshipController",function($scope,$http,relationshipService, securityService ,entityService,fieldService,tabService,enumFieldService,annotationService,annotationAttributeService,enumEntityService,projectService,entityGroupService,restrictionEntityGroupService,roleService,restrictionFieldService,restrictionEntityService,userService,enumValueService)
{
//enumField
...
enumFieldService.selectedEntity.relationshipList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumFieldService.selectedEntity.relationshipList.length; i++)

{

if (enumFieldService.selectedEntity.relationshipList[i].relationshipId==relationshipService.selectedEntity.relationshipId)

enumFieldService.selectedEntity.relationshipList.splice(i,1);

}

enumFieldService.selectedEntity.relationshipList.push(relationshipService.selectedEntity);
...
relationshipService.setSelectedEntity(null);
enumFieldService.initRelationshipList().then(function(response) {
enumFieldService.childrenList.relationshipList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
relationshipService.selectedEntity.restrictionEntityGroupList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<relationshipService.selectedEntity.restrictionEntityGroupList.length; i++)

{

if (relationshipService.selectedEntity.restrictionEntityGroupList[i].restrictionEntityGroupId==restrictionEntityGroupService.selectedEntity.restrictionEntityGroupId)

relationshipService.selectedEntity.restrictionEntityGroupList.splice(i,1);
...
restrictionEntityGroupService.setSelectedEntity(null);
relationshipService.initRestrictionEntityGroupList().then(function(response) {
relationshipService.childrenList.restrictionEntityGroupList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("enumEntityController",function($scope,$http,enumEntityService, securityService ,projectService,entityGroupService,restrictionEntityGroupService,roleService,restrictionFieldService,fieldService,tabService,enumFieldService,annotationService,relationshipService,entityService,restrictionEntityService,annotationAttributeService,userService,enumValueService)
{
...
enumEntityService.selectedEntity.show=false;
enumEntityService.selectedEntity.restrictionEntityGroupList.push(restrictionEntityGroupService.selectedEntity);
enumEntityService.insert().then(function successCallBack(response) { 
restrictionEntityGroupService.selectedEntity.enumEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<restrictionEntityGroupService.selectedEntity.enumEntityList.length; i++)

{

if (restrictionEntityGroupService.selectedEntity.enumEntityList[i].enumEntityId==enumEntityService.selectedEntity.enumEntityId)

restrictionEntityGroupService.selectedEntity.enumEntityList.splice(i,1);

}

restrictionEntityGroupService.selectedEntity.enumEntityList.push(enumEntityService.selectedEntity);
...
enumEntityService.setSelectedEntity(null);
restrictionEntityGroupService.initEnumEntityList().then(function(response) {
restrictionEntityGroupService.childrenList.enumEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

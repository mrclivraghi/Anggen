...
.run(function($rootScope,securityService,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService){
...
.controller("entityGroupController",function($scope,$http,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService)
{
//null
...
projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;}
$scope.addNew= function()
{
entityGroupService.setSelectedEntity(null);
entityGroupService.setEntityList(null);
entityGroupService.selectedEntity.show=true;
projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;$('#entityGroupTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.entityGroupDetailForm.$valid) return; 
projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;entityGroupService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;roleService.selectedEntity.show=false;entityService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("tabController",function($scope,$http,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService)
{
//entityGroup
...
.controller("enumEntityController",function($scope,$http,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService)
{
//entityGroup
...
.controller("enumFieldController",function($scope,$http,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService)
{
//entityGroup
...
.controller("restrictionEntityController",function($scope,$http,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService)
{
//entityGroup
...
.controller("projectController",function($scope,$http,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService)
{
//entityGroup
...
projectService.selectedEntity.show=false;
projectService.selectedEntity.entityGroup={};
projectService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
...
.controller("fieldController",function($scope,$http,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService)
{
//entityGroup
...
.controller("restrictionEntityGroupController",function($scope,$http,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService)
{
//entityGroup
...
.controller("roleController",function($scope,$http,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService)
{
//entityGroup
...
roleService.selectedEntity.show=false;
roleService.selectedEntity.entityGroup={};
roleService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
...
.controller("relationshipController",function($scope,$http,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService)
{
//entityGroup
...
.controller("entityController",function($scope,$http,entityGroupService, securityService ,projectService,enumEntityService,restrictionEntityGroupService,roleService,entityService,fieldService,restrictionEntityService,tabService,enumFieldService,relationshipService)
{
//entityGroup

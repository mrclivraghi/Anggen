...
.run(function($rootScope,securityService,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService){
...
.controller("enumValueController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//null
...
enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;}
$scope.addNew= function()
{
enumValueService.setSelectedEntity(null);
enumValueService.setEntityList(null);
enumValueService.selectedEntity.show=true;
enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#enumValueTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.enumValueDetailForm.$valid) return; 
enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;enumValueService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("tabController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
tabService.selectedEntity.show=false;
tabService.selectedEntity.enumValue={};
tabService.selectedEntity.enumValue.enumValueId=enumValueService.selectedEntity.enumValueId;
tabService.insert().then(function successCallBack(response) { 
enumValueService.selectedEntity.tabList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.tabList.length; i++)

{

if (enumValueService.selectedEntity.tabList[i].tabId==tabService.selectedEntity.tabId)

enumValueService.selectedEntity.tabList.splice(i,1);

}

enumValueService.selectedEntity.tabList.push(tabService.selectedEntity);
...
tabService.setSelectedEntity(null);
enumValueService.initTabList().then(function(response) {
enumValueService.childrenList.tabList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("enumEntityController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
.controller("annotationController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.enumValue={};
annotationService.selectedEntity.enumValue.enumValueId=enumValueService.selectedEntity.enumValueId;
...
.controller("enumFieldController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
enumValueService.selectedEntity.enumFieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.enumFieldList.length; i++)

{

if (enumValueService.selectedEntity.enumFieldList[i].enumFieldId==enumFieldService.selectedEntity.enumFieldId)

enumValueService.selectedEntity.enumFieldList.splice(i,1);

}

enumValueService.selectedEntity.enumFieldList.push(enumFieldService.selectedEntity);
...
.controller("fieldController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
enumValueService.selectedEntity.field=response.data;
...
enumValueService.selectedEntity.field=fieldService.selectedEntity;
...
{
fieldService.selectedEntity.show=false;
enumValueService.selectedEntity.field=null;
fieldService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
annotationAttributeService.selectedEntity.show=false;
annotationAttributeService.selectedEntity.enumValue={};
annotationAttributeService.selectedEntity.enumValue.enumValueId=enumValueService.selectedEntity.enumValueId;
annotationAttributeService.insert().then(function successCallBack(response) { 
enumValueService.selectedEntity.annotationAttributeList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.annotationAttributeList.length; i++)

{

if (enumValueService.selectedEntity.annotationAttributeList[i].annotationAttributeId==annotationAttributeService.selectedEntity.annotationAttributeId)

enumValueService.selectedEntity.annotationAttributeList.splice(i,1);
...
annotationAttributeService.setSelectedEntity(null);
enumValueService.initAnnotationAttributeList().then(function(response) {
enumValueService.childrenList.annotationAttributeList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("entityGroupController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
entityGroupService.selectedEntity.show=false;
entityGroupService.selectedEntity.enumValue={};
entityGroupService.selectedEntity.enumValue.enumValueId=enumValueService.selectedEntity.enumValueId;
entityGroupService.insert().then(function successCallBack(response) { 
enumValueService.selectedEntity.entityGroupList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.entityGroupList.length; i++)

{

if (enumValueService.selectedEntity.entityGroupList[i].entityGroupId==entityGroupService.selectedEntity.entityGroupId)

enumValueService.selectedEntity.entityGroupList.splice(i,1);

}

enumValueService.selectedEntity.entityGroupList.push(entityGroupService.selectedEntity);
...
entityGroupService.setSelectedEntity(null);
enumValueService.initEntityGroupList().then(function(response) {
enumValueService.childrenList.entityGroupList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("projectController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
.controller("roleController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
enumValueService.selectedEntity.role=response.data;
...
enumValueService.selectedEntity.role=roleService.selectedEntity;
...
{
roleService.selectedEntity.show=false;
enumValueService.selectedEntity.role=null;
roleService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("entityController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.enumValue={};
entityService.selectedEntity.enumValue.enumValueId=enumValueService.selectedEntity.enumValueId;
...
.controller("userController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
enumValueService.selectedEntity.userList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.userList.length; i++)

{

if (enumValueService.selectedEntity.userList[i].userId==userService.selectedEntity.userId)

enumValueService.selectedEntity.userList.splice(i,1);
...
userService.setSelectedEntity(null);
enumValueService.initUserList().then(function(response) {
enumValueService.childrenList.userList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("restrictionFieldController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
restrictionFieldService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.enumValue={};
restrictionFieldService.selectedEntity.enumValue.enumValueId=enumValueService.selectedEntity.enumValueId;
...
restrictionEntityGroupService.selectedEntity.show=false;
restrictionEntityGroupService.selectedEntity.enumValue={};
restrictionEntityGroupService.selectedEntity.enumValue.enumValueId=enumValueService.selectedEntity.enumValueId;
restrictionEntityGroupService.insert().then(function successCallBack(response) { 
enumValueService.selectedEntity.restrictionEntityGroupList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.restrictionEntityGroupList.length; i++)

{

if (enumValueService.selectedEntity.restrictionEntityGroupList[i].restrictionEntityGroupId==restrictionEntityGroupService.selectedEntity.restrictionEntityGroupId)

enumValueService.selectedEntity.restrictionEntityGroupList.splice(i,1);
...
restrictionEntityGroupService.setSelectedEntity(null);
enumValueService.initRestrictionEntityGroupList().then(function(response) {
enumValueService.childrenList.restrictionEntityGroupList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("restrictionEntityController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
restrictionEntityService.selectedEntity.show=false;
restrictionEntityService.selectedEntity.enumValue={};
restrictionEntityService.selectedEntity.enumValue.enumValueId=enumValueService.selectedEntity.enumValueId;
restrictionEntityService.insert().then(function successCallBack(response) { 
enumValueService.selectedEntity.restrictionEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.restrictionEntityList.length; i++)

{

if (enumValueService.selectedEntity.restrictionEntityList[i].restrictionEntityId==restrictionEntityService.selectedEntity.restrictionEntityId)

enumValueService.selectedEntity.restrictionEntityList.splice(i,1);
...
restrictionEntityService.setSelectedEntity(null);
enumValueService.initRestrictionEntityList().then(function(response) {
enumValueService.childrenList.restrictionEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("relationshipController",function($scope,$http,enumValueService, securityService ,enumEntityService,projectService,entityGroupService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,restrictionFieldService,fieldService,tabService,relationshipService,annotationService,enumFieldService,annotationAttributeService,userService)
{
//enumValue
...
relationshipService.selectedEntity.show=false;
relationshipService.selectedEntity.enumValue={};
relationshipService.selectedEntity.enumValue.enumValueId=enumValueService.selectedEntity.enumValueId;
relationshipService.insert().then(function successCallBack(response) { 
enumValueService.selectedEntity.relationshipList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumValueService.selectedEntity.relationshipList.length; i++)

{

if (enumValueService.selectedEntity.relationshipList[i].relationshipId==relationshipService.selectedEntity.relationshipId)

enumValueService.selectedEntity.relationshipList.splice(i,1);

}

enumValueService.selectedEntity.relationshipList.push(relationshipService.selectedEntity);
...
relationshipService.setSelectedEntity(null);
enumValueService.initRelationshipList().then(function(response) {
enumValueService.childrenList.relationshipList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

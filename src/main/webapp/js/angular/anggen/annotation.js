...
.run(function($rootScope,securityService,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService){
...
.controller("annotationController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//null
...
relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;userService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;}
$scope.addNew= function()
{
annotationService.setSelectedEntity(null);
annotationService.setEntityList(null);
annotationService.selectedEntity.show=true;
relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;userService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;$('#annotationTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.annotationDetailForm.$valid) return; 
relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;userService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;annotationService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
relationshipService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;userService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("tabController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
tabService.selectedEntity.show=false;
tabService.selectedEntity.annotation={};
tabService.selectedEntity.annotation.annotationId=annotationService.selectedEntity.annotationId;
...
.controller("entityController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.annotation={};
entityService.selectedEntity.annotation.annotationId=annotationService.selectedEntity.annotationId;
entityService.insert().then(function successCallBack(response) { 
annotationService.selectedEntity.entity=response.data;
...
annotationService.selectedEntity.entity=entityService.selectedEntity;
...
{
entityService.selectedEntity.show=false;
annotationService.selectedEntity.entity=null;
entityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("restrictionFieldController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
restrictionFieldService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.annotation={};
restrictionFieldService.selectedEntity.annotation.annotationId=annotationService.selectedEntity.annotationId;
...
.controller("relationshipController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
.controller("enumFieldController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
enumFieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.annotation={};
enumFieldService.selectedEntity.annotation.annotationId=annotationService.selectedEntity.annotationId;
...
.controller("enumValueController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.annotation={};
enumValueService.selectedEntity.annotation.annotationId=annotationService.selectedEntity.annotationId;
...
.controller("annotationAttributeController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
.controller("roleController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
annotationService.selectedEntity.role=response.data;
...
annotationService.selectedEntity.role=roleService.selectedEntity;
...
{
roleService.selectedEntity.show=false;
annotationService.selectedEntity.role=null;
roleService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("enumEntityController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
annotationService.selectedEntity.enumEntity=response.data;
annotationService.initEnumEntityList().then(function(response) {
annotationService.childrenList.enumEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
annotationService.selectedEntity.enumEntity=enumEntityService.selectedEntity;
...
{
enumEntityService.selectedEntity.show=false;
annotationService.selectedEntity.enumEntity=null;
enumEntityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("projectController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
annotationService.selectedEntity.project=response.data;
annotationService.initProjectList().then(function(response) {
annotationService.childrenList.projectList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
annotationService.selectedEntity.project=projectService.selectedEntity;
...
{
projectService.selectedEntity.show=false;
annotationService.selectedEntity.project=null;
projectService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("restrictionEntityGroupController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
restrictionEntityGroupService.selectedEntity.show=false;
restrictionEntityGroupService.selectedEntity.annotation={};
restrictionEntityGroupService.selectedEntity.annotation.annotationId=annotationService.selectedEntity.annotationId;
restrictionEntityGroupService.insert().then(function successCallBack(response) { 
annotationService.selectedEntity.restrictionEntityGroupList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<annotationService.selectedEntity.restrictionEntityGroupList.length; i++)

{

if (annotationService.selectedEntity.restrictionEntityGroupList[i].restrictionEntityGroupId==restrictionEntityGroupService.selectedEntity.restrictionEntityGroupId)

annotationService.selectedEntity.restrictionEntityGroupList.splice(i,1);
...
restrictionEntityGroupService.setSelectedEntity(null);
annotationService.initRestrictionEntityGroupList().then(function(response) {
annotationService.childrenList.restrictionEntityGroupList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("entityGroupController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
annotationService.selectedEntity.entityGroup=response.data;
annotationService.initEntityGroupList().then(function(response) {
annotationService.childrenList.entityGroupList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
annotationService.selectedEntity.entityGroup=entityGroupService.selectedEntity;
...
{
entityGroupService.selectedEntity.show=false;
annotationService.selectedEntity.entityGroup=null;
entityGroupService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("userController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
userService.selectedEntity.show=false;
userService.selectedEntity.annotationList.push(annotationService.selectedEntity);
userService.insert().then(function successCallBack(response) { 
annotationService.selectedEntity.userList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<annotationService.selectedEntity.userList.length; i++)

{

if (annotationService.selectedEntity.userList[i].userId==userService.selectedEntity.userId)

annotationService.selectedEntity.userList.splice(i,1);

}

annotationService.selectedEntity.userList.push(userService.selectedEntity);
...
userService.setSelectedEntity(null);
annotationService.initUserList().then(function(response) {
annotationService.childrenList.userList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("fieldController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
.controller("restrictionEntityController",function($scope,$http,annotationService, securityService ,relationshipService,entityService,restrictionEntityService,roleService,restrictionEntityGroupService,entityGroupService,projectService,enumEntityService,enumValueService,restrictionFieldService,fieldService,tabService,enumFieldService,userService,annotationAttributeService)
{
//annotation
...
restrictionEntityService.selectedEntity.show=false;
restrictionEntityService.selectedEntity.annotation={};
restrictionEntityService.selectedEntity.annotation.annotationId=annotationService.selectedEntity.annotationId;
restrictionEntityService.insert().then(function successCallBack(response) { 
annotationService.selectedEntity.restrictionEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<annotationService.selectedEntity.restrictionEntityList.length; i++)

{

if (annotationService.selectedEntity.restrictionEntityList[i].restrictionEntityId==restrictionEntityService.selectedEntity.restrictionEntityId)

annotationService.selectedEntity.restrictionEntityList.splice(i,1);
...
restrictionEntityService.setSelectedEntity(null);
annotationService.initRestrictionEntityList().then(function(response) {
annotationService.childrenList.restrictionEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

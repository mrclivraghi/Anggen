...
public interface AnnotationAttributeRepository
    extends JpaRepository<it.anggen.model.field.AnnotationAttribute, java.lang.Long>
{


    @Query("select a from AnnotationAttribute a")
    public List<it.anggen.model.field.AnnotationAttribute> findAll();
    ...
    public List<it.anggen.model.field.AnnotationAttribute> findByAnnotationAttributeIdAndPropertyAndValueAndAnnotation(

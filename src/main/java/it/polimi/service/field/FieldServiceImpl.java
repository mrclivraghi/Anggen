    ...
    implements FieldService
{
    ...
    public it.polimi.model.field.Field update(it.polimi.model.field.Field field) {
        ...
        it.polimi.model.field.Field returnedField=fieldRepository.save(field);
        if (field.getEntity()!=null)
        {
        List<it.polimi.model.field.Field> fieldList = fieldRepository.findByEntity( field.getEntity());
        ...
        {
        List<it.polimi.model.field.Field> fieldList = fieldRepository.findByTab( field.getTab());
        if (!fieldList.contains(returnedField))
        fieldList.add(returnedField);

    ...
    extends CrudRepository<it.anggen.model.field.EnumValue, java.lang.Long>
{
    ...
    @Query("select e from EnumValue e where  (:enumValueId is null or cast(:enumValueId as string)=cast(e.enumValueId as string)) and (:name is null or :name='' or cast(:name as string)=e.name) and (:value is null or cast(:value as string)=cast(e.value as string))")

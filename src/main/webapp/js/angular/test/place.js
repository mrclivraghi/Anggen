var placeApp=angular.module("placeApp",['ngFileUpload','ngTouch', 'ui.grid', 'ui.grid.pagination','ui.grid.selection','ui.date', 'ui.grid.exporter'])
...
{ name: 'placeId'},
{ name: 'placeName'},
{ name: 'example.exampleId', displayName: 'example'} 
]

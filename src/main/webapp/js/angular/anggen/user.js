...
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;}
$scope.addNew= function()
{
userService.setSelectedEntity(null);
userService.setEntityList(null);
userService.selectedEntity.show=true;
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;$('#userTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.userDetailForm.$valid) return; 
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("tabController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
tabService.selectedEntity.show=false;
tabService.selectedEntity.user={};
tabService.selectedEntity.user.userId=userService.selectedEntity.userId;
tabService.insert().then(function successCallBack(response) { 
userService.selectedEntity.tabList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<userService.selectedEntity.tabList.length; i++)

{

if (userService.selectedEntity.tabList[i].tabId==tabService.selectedEntity.tabId)

userService.selectedEntity.tabList.splice(i,1);
...
tabService.setSelectedEntity(null);
userService.initTabList().then(function(response) {
userService.childrenList.tabList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("annotationController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.user={};
annotationService.selectedEntity.user.userId=userService.selectedEntity.userId;
annotationService.insert().then(function successCallBack(response) { 
userService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<userService.selectedEntity.annotationList.length; i++)

{

if (userService.selectedEntity.annotationList[i].annotationId==annotationService.selectedEntity.annotationId)

userService.selectedEntity.annotationList.splice(i,1);
...
annotationService.setSelectedEntity(null);
userService.initAnnotationList().then(function(response) {
userService.childrenList.annotationList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("restrictionEntityController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
restrictionEntityService.selectedEntity.show=false;
restrictionEntityService.selectedEntity.user={};
restrictionEntityService.selectedEntity.user.userId=userService.selectedEntity.userId;
...
.controller("enumFieldController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
enumFieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.user={};
enumFieldService.selectedEntity.user.userId=userService.selectedEntity.userId;
...
.controller("fieldController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
userService.selectedEntity.field=response.data;
userService.initFieldList().then(function(response) {
userService.childrenList.fieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
userService.selectedEntity.field=fieldService.selectedEntity;
...
{
fieldService.selectedEntity.show=false;
userService.selectedEntity.field=null;
fieldService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("enumValueController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.user={};
enumValueService.selectedEntity.user.userId=userService.selectedEntity.userId;
...
.controller("annotationAttributeController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
annotationAttributeService.selectedEntity.show=false;
annotationAttributeService.selectedEntity.user={};
annotationAttributeService.selectedEntity.user.userId=userService.selectedEntity.userId;
...
.controller("roleController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
.controller("enumEntityController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
enumEntityService.selectedEntity.show=false;
enumEntityService.selectedEntity.userList.push(userService.selectedEntity);
enumEntityService.insert().then(function successCallBack(response) { 
userService.selectedEntity.enumEntity=response.data;
userService.initEnumEntityList().then(function(response) {
userService.childrenList.enumEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
userService.selectedEntity.enumEntity=enumEntityService.selectedEntity;
...
{
enumEntityService.selectedEntity.show=false;
userService.selectedEntity.enumEntity=null;
enumEntityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("projectController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
userService.selectedEntity.project=response.data;
...
userService.selectedEntity.project=projectService.selectedEntity;
...
{
projectService.selectedEntity.show=false;
userService.selectedEntity.project=null;
projectService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("restrictionEntityGroupController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
restrictionEntityGroupService.selectedEntity.show=false;
restrictionEntityGroupService.selectedEntity.user={};
restrictionEntityGroupService.selectedEntity.user.userId=userService.selectedEntity.userId;
...
.controller("entityGroupController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
userService.selectedEntity.entityGroup=response.data;
userService.initEntityGroupList().then(function(response) {
userService.childrenList.entityGroupList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
userService.selectedEntity.entityGroup=entityGroupService.selectedEntity;
...
{
entityGroupService.selectedEntity.show=false;
userService.selectedEntity.entityGroup=null;
entityGroupService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("entityController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.userList.push(userService.selectedEntity);
entityService.insert().then(function successCallBack(response) { 
userService.selectedEntity.entity=response.data;
userService.initEntityList().then(function(response) {
userService.childrenList.entityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
userService.selectedEntity.entity=entityService.selectedEntity;
...
{
entityService.selectedEntity.show=false;
userService.selectedEntity.entity=null;
entityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("restrictionFieldController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
restrictionFieldService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.user={};
restrictionFieldService.selectedEntity.user.userId=userService.selectedEntity.userId;
...
.controller("relationshipController",function($scope,$http,userService, securityService ,roleService,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService)
{
//user
...
relationshipService.selectedEntity.show=false;
relationshipService.selectedEntity.user={};
relationshipService.selectedEntity.user.userId=userService.selectedEntity.userId;

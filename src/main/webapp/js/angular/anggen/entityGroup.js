...
.run(function($rootScope,securityService,entityGroupService, securityService ,projectService,enumEntityService,enumValueService,entityService,relationshipService,tabService,fieldService,annotationService,enumFieldService,annotationAttributeService,restrictionFieldService,roleService,restrictionEntityGroupService,restrictionEntityService,userService){
...
projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;}
$scope.addNew= function()
{
entityGroupService.setSelectedEntity(null);
entityGroupService.setEntityList(null);
entityGroupService.selectedEntity.show=true;
projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#entityGroupTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.entityGroupDetailForm.$valid) return; 
projectService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;entityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;entityGroupService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
enumEntityService.selectedEntity.show=false;
enumEntityService.selectedEntity.entityGroup={};
enumEntityService.selectedEntity.entityGroup.entityGroupId=entityGroupService.selectedEntity.entityGroupId;
enumEntityService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.enumEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<entityGroupService.selectedEntity.enumEntityList.length; i++)

{

if (entityGroupService.selectedEntity.enumEntityList[i].enumEntityId==enumEntityService.selectedEntity.enumEntityId)

entityGroupService.selectedEntity.enumEntityList.splice(i,1);
...
tabService.selectedEntity.show=false;
tabService.selectedEntity.entityGroupList.push(entityGroupService.selectedEntity);
tabService.insert().then(function successCallBack(response) { 
entityGroupService.selectedEntity.tab=response.data;
...
entityGroupService.selectedEntity.tab=tabService.selectedEntity;
...
{
tabService.selectedEntity.show=false;
entityGroupService.selectedEntity.tab=null;
tabService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()

    ...
    implements FieldService
{
    ...
    public List<it.anggen.model.field.Field> find(FieldSearchBean field) {
        return fieldRepository.findByFieldIdAndPriorityAndNameAndFieldTypeAndEntityAndAnnotationAndRestrictionFieldAndTab(field.getFieldId(),field.getPriority(),field.getName(), (field.getFieldType()==null)? null : field.getFieldType().getValue(),field.getEntity(),field.getAnnotationList()==null? null :field.getAnnotationList().get(0),field.getRestrictionFieldList()==null? null :field.getRestrictionFieldList().get(0),field.getTab());
    }

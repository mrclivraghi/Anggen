...
fieldService.selectedEntity.show=false;
fieldService.selectedEntity.enumEntityList.push(enumEntityService.selectedEntity);
fieldService.insert().then(function successCallBack(response) { 
enumEntityService.selectedEntity.fieldList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<enumEntityService.selectedEntity.fieldList.length; i++)

{

if (enumEntityService.selectedEntity.fieldList[i].fieldId==fieldService.selectedEntity.fieldId)

enumEntityService.selectedEntity.fieldList.splice(i,1);
...
fieldService.setSelectedEntity(null);
enumEntityService.initFieldList().then(function(response) {
enumEntityService.childrenList.fieldList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");

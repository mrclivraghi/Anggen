    ...
    implements RestrictionEntityGroupService
{
    ...
    public List<it.anggen.model.security.RestrictionEntityGroup> find(RestrictionEntityGroupSearchBean restrictionEntityGroup) {
        return restrictionEntityGroupRepository.findByRestrictionEntityGroupIdAndCanUpdateAndCanCreateAndCanDeleteAndCanSearchAndRoleAndEntityGroup(restrictionEntityGroup.getRestrictionEntityGroupId(),restrictionEntityGroup.getCanUpdate(),restrictionEntityGroup.getCanCreate(),restrictionEntityGroup.getCanDelete(),restrictionEntityGroup.getCanSearch(),restrictionEntityGroup.getRole(),restrictionEntityGroup.getEntityGroup());
    }

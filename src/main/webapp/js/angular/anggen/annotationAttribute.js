...
.run(function($rootScope,securityService,annotationAttributeService, securityService ,annotationService,fieldService,entityService,relationshipService,tabService,enumFieldService,enumValueService,restrictionEntityService,roleService,userService,restrictionFieldService,restrictionEntityGroupService,entityGroupService,projectService){
...
{
if (!$scope.annotationAttributeDetailForm.$valid) return; 
annotationService.selectedEntity.show=false;fieldService.selectedEntity.show=false;entityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;roleService.selectedEntity.show=false;userService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;projectService.selectedEntity.show=false;annotationAttributeService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
alert("error");
return; 
...
annotationAttributeService.selectedEntity.relationshipList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
annotationAttributeService.selectedEntity.annotationList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
annotationAttributeService.selectedEntity.entityList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<annotationAttributeService.selectedEntity.entityList.length; i++)

{

if (annotationAttributeService.selectedEntity.entityList[i].entityId==entityService.selectedEntity.entityId)

annotationAttributeService.selectedEntity.entityList.splice(i,1);
...
annotationAttributeService.selectedEntity.projectList.push(response.data);
},function errorCallback(response) { 
alert("error");
return; 
});
...
for (i=0; i<annotationAttributeService.selectedEntity.projectList.length; i++)

{

if (annotationAttributeService.selectedEntity.projectList[i].projectId==projectService.selectedEntity.projectId)

annotationAttributeService.selectedEntity.projectList.splice(i,1);

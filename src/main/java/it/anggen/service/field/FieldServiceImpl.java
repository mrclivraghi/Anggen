    ...
    implements FieldService
{
    ...
    public List<it.anggen.model.field.Field> find(FieldSearchBean field) {
        return fieldRepository.findByFieldIdAndNameAndPriorityAndFieldTypeAndAnnotationAndRestrictionFieldAndTabAndEntity(field.getFieldId(),field.getName(),field.getPriority(), (field.getFieldType()==null)? null : field.getFieldType().getValue(),field.getAnnotationList()==null? null :field.getAnnotationList().get(0),field.getRestrictionFieldList()==null? null :field.getRestrictionFieldList().get(0),field.getTab(),field.getEntity());
    }

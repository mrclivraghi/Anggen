...
.run(function($rootScope,securityService,roleService, securityService ,restrictionEntityGroupService,entityGroupService,restrictionFieldService,fieldService,restrictionEntityService,entityService,userService){
...
.controller("roleController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,restrictionFieldService,fieldService,restrictionEntityService,entityService,userService)
{
//null
...
restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityService.selectedEntity.show=false;userService.selectedEntity.show=false;}
$scope.addNew= function()
{
roleService.setSelectedEntity(null);
roleService.setEntityList(null);
roleService.selectedEntity.show=true;
restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#roleTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.roleDetailForm.$valid) return; 
restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityService.selectedEntity.show=false;userService.selectedEntity.show=false;roleService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;entityService.selectedEntity.show=false;userService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("entityGroupController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,restrictionFieldService,fieldService,restrictionEntityService,entityService,userService)
{
//role
...
entityGroupService.selectedEntity.show=false;
entityGroupService.selectedEntity.role={};
entityGroupService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
...
.controller("entityController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,restrictionFieldService,fieldService,restrictionEntityService,entityService,userService)
{
//role
...
roleService.selectedEntity.entity=response.data;
...
roleService.selectedEntity.entity=entityService.selectedEntity;
...
{
entityService.selectedEntity.show=false;
roleService.selectedEntity.entity=null;
entityService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("restrictionFieldController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,restrictionFieldService,fieldService,restrictionEntityService,entityService,userService)
{
//role
...
.controller("fieldController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,restrictionFieldService,fieldService,restrictionEntityService,entityService,userService)
{
//role
...
roleService.selectedEntity.field=response.data;
...
roleService.selectedEntity.field=fieldService.selectedEntity;
...
{
fieldService.selectedEntity.show=false;
roleService.selectedEntity.field=null;
fieldService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("userController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,restrictionFieldService,fieldService,restrictionEntityService,entityService,userService)
{
//role
...
.controller("restrictionEntityGroupController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,restrictionFieldService,fieldService,restrictionEntityService,entityService,userService)
{
//role
...
.controller("restrictionEntityController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,restrictionFieldService,fieldService,restrictionEntityService,entityService,userService)
{
//role

...
.run(function($rootScope,securityService,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,restrictionEntityService,userService,fieldService,tabService,annotationService,entityService){
...
.controller("restrictionFieldController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,restrictionEntityService,userService,fieldService,tabService,annotationService,entityService)
{
//null
...
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;entityService.selectedEntity.show=false;}
$scope.addNew= function()
{
restrictionFieldService.setSelectedEntity(null);
restrictionFieldService.setEntityList(null);
restrictionFieldService.selectedEntity.show=true;
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;entityService.selectedEntity.show=false;$('#restrictionFieldTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.restrictionFieldDetailForm.$valid) return; 
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionFieldService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
roleService.selectedEntity.show=false;restrictionEntityGroupService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;userService.selectedEntity.show=false;fieldService.selectedEntity.show=false;tabService.selectedEntity.show=false;annotationService.selectedEntity.show=false;entityService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("tabController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,restrictionEntityService,userService,fieldService,tabService,annotationService,entityService)
{
//restrictionField
...
.controller("annotationController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,restrictionEntityService,userService,fieldService,tabService,annotationService,entityService)
{
//restrictionField
...
.controller("entityController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,restrictionEntityService,userService,fieldService,tabService,annotationService,entityService)
{
//restrictionField
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.restrictionField={};
entityService.selectedEntity.restrictionField.restrictionFieldId=restrictionFieldService.selectedEntity.restrictionFieldId;
...
.controller("userController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,restrictionEntityService,userService,fieldService,tabService,annotationService,entityService)
{
//restrictionField
...
.controller("fieldController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,restrictionEntityService,userService,fieldService,tabService,annotationService,entityService)
{
//restrictionField
...
.controller("restrictionEntityGroupController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,restrictionEntityService,userService,fieldService,tabService,annotationService,entityService)
{
//restrictionField
...
.controller("restrictionEntityController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,restrictionEntityService,userService,fieldService,tabService,annotationService,entityService)
{
//restrictionField
...
.controller("roleController",function($scope,$http,restrictionFieldService, securityService ,roleService,restrictionEntityGroupService,restrictionEntityService,userService,fieldService,tabService,annotationService,entityService)
{
//restrictionField
...
roleService.selectedEntity.show=false;
roleService.selectedEntity.restrictionField={};
roleService.selectedEntity.restrictionField.restrictionFieldId=restrictionFieldService.selectedEntity.restrictionFieldId;

...
/** @ngInject */
function AnnotationController($scope,$http,$rootScope,$log,UtilityService ,annotationService, SecurityService, MainService ,relationshipService,annotationAttributeService,fieldService,enumFieldService)
{
var vm=this;
vm.activeTab=1;
...
function insert()
{
if (!vm.annotationDetailForm.$valid) return; 

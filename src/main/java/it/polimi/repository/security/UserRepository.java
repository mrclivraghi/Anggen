    ...
    extends CrudRepository<it.polimi.model.security.User, java.lang.Long>
{
    ...
    public List<it.polimi.model.security.User> findByUserId(java.lang.Long userId);

    public List<it.polimi.model.security.User> findByUsername(java.lang.String username);

    public List<it.polimi.model.security.User> findByPassword(java.lang.String password);

    public List<it.polimi.model.security.User> findByEnabled(java.lang.Boolean enabled);
    ...
    public List<it.polimi.model.security.User> findByUserIdAndUsernameAndPasswordAndEnabledAndRole(

...
.run(function($rootScope,securityService,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService){
...
.controller("roleController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//null
...
restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;}
$scope.addNew= function()
{
roleService.setSelectedEntity(null);
roleService.setEntityList(null);
roleService.selectedEntity.show=true;
restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;$('#roleTabs li:eq(0) a').tab('show');
};
...
{
if (!$scope.roleDetailForm.$valid) return; 
restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;roleService.update().then(function successCallback(response) { 
$scope.search();
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
restrictionEntityGroupService.selectedEntity.show=false;entityGroupService.selectedEntity.show=false;entityService.selectedEntity.show=false;restrictionEntityService.selectedEntity.show=false;relationshipService.selectedEntity.show=false;tabService.selectedEntity.show=false;fieldService.selectedEntity.show=false;restrictionFieldService.selectedEntity.show=false;annotationService.selectedEntity.show=false;enumFieldService.selectedEntity.show=false;enumEntityService.selectedEntity.show=false;projectService.selectedEntity.show=false;enumValueService.selectedEntity.show=false;annotationAttributeService.selectedEntity.show=false;userService.selectedEntity.show=false;if (row.isSelected)
{
...
.controller("tabController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
tabService.selectedEntity.show=false;
tabService.selectedEntity.role={};
tabService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
tabService.insert().then(function successCallBack(response) { 
roleService.selectedEntity.tabList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<roleService.selectedEntity.tabList.length; i++)

{

if (roleService.selectedEntity.tabList[i].tabId==tabService.selectedEntity.tabId)

roleService.selectedEntity.tabList.splice(i,1);

}

roleService.selectedEntity.tabList.push(tabService.selectedEntity);
...
tabService.setSelectedEntity(null);
roleService.initTabList().then(function(response) {
roleService.childrenList.tabList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("restrictionFieldController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
restrictionFieldService.selectedEntity.show=false;
restrictionFieldService.selectedEntity.role={};
restrictionFieldService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
...
.controller("enumFieldController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
enumFieldService.selectedEntity.show=false;
enumFieldService.selectedEntity.role={};
enumFieldService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
...
.controller("projectController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
roleService.selectedEntity.project=response.data;
roleService.initProjectList().then(function(response) {
roleService.childrenList.projectList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
roleService.selectedEntity.project=projectService.selectedEntity;
...
{
projectService.selectedEntity.show=false;
roleService.selectedEntity.project=null;
projectService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("enumValueController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
enumValueService.selectedEntity.show=false;
enumValueService.selectedEntity.role={};
enumValueService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
...
.controller("annotationAttributeController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
annotationAttributeService.selectedEntity.show=false;
annotationAttributeService.selectedEntity.role={};
annotationAttributeService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
annotationAttributeService.insert().then(function successCallBack(response) { 
roleService.selectedEntity.annotationAttributeList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<roleService.selectedEntity.annotationAttributeList.length; i++)

{

if (roleService.selectedEntity.annotationAttributeList[i].annotationAttributeId==annotationAttributeService.selectedEntity.annotationAttributeId)

roleService.selectedEntity.annotationAttributeList.splice(i,1);
...
annotationAttributeService.setSelectedEntity(null);
roleService.initAnnotationAttributeList().then(function(response) {
roleService.childrenList.annotationAttributeList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
...
.controller("annotationController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
annotationService.selectedEntity.show=false;
annotationService.selectedEntity.role={};
annotationService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
...
.controller("entityGroupController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
entityGroupService.selectedEntity.show=false;
entityGroupService.selectedEntity.roleList.push(roleService.selectedEntity);
entityGroupService.insert().then(function successCallBack(response) { 
roleService.selectedEntity.entityGroup=response.data;
...
roleService.selectedEntity.entityGroup=entityGroupService.selectedEntity;
...
{
entityGroupService.selectedEntity.show=false;
roleService.selectedEntity.entityGroup=null;
entityGroupService.setSelectedEntity(null);
$scope.updateParent();
};
$scope.del=function()
...
.controller("restrictionEntityGroupController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
.controller("entityController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
entityService.selectedEntity.show=false;
entityService.selectedEntity.role={};
entityService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
...
.controller("userController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
.controller("fieldController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
fieldService.selectedEntity.show=false;
fieldService.selectedEntity.role={};
fieldService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
...
.controller("restrictionEntityController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
restrictionEntityService.selectedEntity.show=false;
restrictionEntityService.selectedEntity.role={};
restrictionEntityService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
...
.controller("relationshipController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
relationshipService.selectedEntity.show=false;
relationshipService.selectedEntity.role={};
relationshipService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
...
.controller("enumEntityController",function($scope,$http,roleService, securityService ,restrictionEntityGroupService,entityGroupService,entityService,restrictionEntityService,relationshipService,tabService,fieldService,restrictionFieldService,annotationService,enumFieldService,enumEntityService,projectService,enumValueService,annotationAttributeService,userService)
{
//role
...
enumEntityService.selectedEntity.show=false;
enumEntityService.selectedEntity.role={};
enumEntityService.selectedEntity.role.roleId=roleService.selectedEntity.roleId;
enumEntityService.insert().then(function successCallBack(response) { 
roleService.selectedEntity.enumEntityList.push(response.data);
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
return; 
...
for (i=0; i<roleService.selectedEntity.enumEntityList.length; i++)

{

if (roleService.selectedEntity.enumEntityList[i].enumEntityId==enumEntityService.selectedEntity.enumEntityId)

roleService.selectedEntity.enumEntityList.splice(i,1);

}

roleService.selectedEntity.enumEntityList.push(enumEntityService.selectedEntity);
...
enumEntityService.setSelectedEntity(null);
roleService.initEnumEntityList().then(function(response) {
roleService.childrenList.enumEntityList=response.data;
});
},function errorCallback(response) { 
AlertError.init({selector: "#alertError"});
AlertError.show("Si è verificato un errore");
